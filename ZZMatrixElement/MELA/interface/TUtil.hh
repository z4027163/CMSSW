...
double SumMatrixElementPDF(TVar::Process procees, TVar::Production production, TVar::MatrixElement matrixElement, event_scales_type* event_scales, mcfm_event_type* mcfm_event, double flavor_msq[][11], double* flux, double EBEAM, double coupling[SIZE_HVV_FREENORM]);
...
double HJJMatEl(TVar::Process process, TVar::Production production, TVar::MatrixElement matrixElement, event_scales_type* event_scales, const TLorentzVector p[5], double Hggcoupl[SIZE_HGG][2], double Hvvcoupl[SIZE_HVV_VBF][2], double Hwwcoupl[SIZE_HWW_VBF][2], TVar::VerbosityLevel verb, double EBEAM);
