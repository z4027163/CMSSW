#include <ZZMatrixElement/MELA/interface/SpinTwoDecayMELA.h>
...
SpinTwoDecayMELA::SpinTwoDecayMELA(){
...
void SpinTwoDecayMELA::checkZorder(float& z1mass, float& z2mass,
...
void SpinTwoDecayMELA::computeKD(TLorentzVector Z1_lept1, int Z1_lept1Id,
...
void SpinTwoDecayMELA::computeKD(float zzmass, float z1mass, 
