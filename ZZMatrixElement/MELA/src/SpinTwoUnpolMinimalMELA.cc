#include <ZZMatrixElement/MELA/interface/SpinTwoUnpolMinimalMELA.h>
...
SpinTwoUnpolMinimalMELA::SpinTwoUnpolMinimalMELA(){
...
void SpinTwoUnpolMinimalMELA::checkZorder(float& z1mass, float& z2mass,
...
void SpinTwoUnpolMinimalMELA::computeKD(TLorentzVector Z1_lept1, int Z1_lept1Id,
  ...
  psigALT = minGrav->PDF->getVal();
  kd = 1/(1+psigALT/psig);
  
}


void SpinTwoUnpolMinimalMELA::computeKD(float zzmass, float z1mass, 
