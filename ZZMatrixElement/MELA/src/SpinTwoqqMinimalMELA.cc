#include <ZZMatrixElement/MELA/interface/SpinTwoqqMinimalMELA.h>
...
SpinTwoqqMinimalMELA::SpinTwoqqMinimalMELA(){
...
void SpinTwoqqMinimalMELA::checkZorder(float& z1mass, float& z2mass,
...
void SpinTwoqqMinimalMELA::computeKD(TLorentzVector Z1_lept1, int Z1_lept1Id,
...
void SpinTwoqqMinimalMELA::computeKD(float zzmass, float z1mass, 
