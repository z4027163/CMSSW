...
namespace l1t {
   namespace stage2 {
      class RegionalMuonUnpacker : public Unpacker {
         public:
...
namespace l1t {
   namespace stage2 {
      bool
      RegionalMuonUnpacker::unpack(const Block& block, UnpackerCollections *coll)
      {
...
DEFINE_L1T_UNPACKER(l1t::stage2::RegionalMuonUnpacker);
