...
#ifndef __ph_pattern_h_file__
#define __ph_pattern_h_file__
#include "vppc_sim_lib.h"

class ph_pattern
{
 public:
	ph_pattern(){built = false; glbl_gsr = true; defparam();}
	void defparam();
	void build();
	bool built;
	bool glbl_gsr;
...
signal_storage bx__storage;  signal_ bx;
		signal_storage lyhits__storage;  signal_ lyhits;
		signal_storage qcode_p__storage;  signal_ qcode_p;
		signal_storage straightness__storage;  signal_ straightness;
		signal_storage comp1__storage;  signal_ comp1;
		signal_storage comp2__storage;  signal_ comp2;
		signal_storage comp3__storage;  signal_ comp3;
