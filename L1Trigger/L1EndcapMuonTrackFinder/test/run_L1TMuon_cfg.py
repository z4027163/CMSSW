...
process.load('L1Trigger.L1EndcapMuonTrackFinder.L1CSCTFTrackConverter_cfi')
process.load('L1Trigger.L1EndcapMuonTrackFinder.L1DTTFTrackConverter_cfi')
process.load('L1Trigger.L1EndcapMuonTrackFinder.L1RPCTFTrackConverter_cfi')
