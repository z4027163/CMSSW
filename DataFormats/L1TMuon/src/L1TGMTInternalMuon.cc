...
L1TGMTInternalMuon::L1TGMTInternalMuon(const edm::Handle<L1TRegionalMuonCandidateCollection>& regional, size_t index, int globalPhi) :
  m_regional(regional, index), m_hwRank(0), m_hwCancelBit(0), m_hwIsoSum(0), m_hwDeltaEta(0), m_hwDeltaPhi(0), m_hwAbsIso(-1), m_hwRelIso(-1), m_hwGlobalPhi(globalPhi)
{
