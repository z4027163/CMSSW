...
##process.HcalAlignmentRcd = cms.ESSource("EmptyESSource",
##                                         iovIsRunNotTime = cms.bool(True),
##                                         recordName = cms.string ("HcalAlignmentRcd"),
##                                         firstValid = cms.vuint32(1)
##                                         )

## process.HBAlignmentRcd = cms.ESSource("EmptyESSource",
##                                          iovIsRunNotTime = cms.bool(True),
##                                          recordName = cms.string ("HBAlignmentRcd"),
##                                          firstValid = cms.vuint32(1)
##                                          )

## process.Alignments = cms.ESSource("EmptyESSource",
##                                         iovIsRunNotTime = cms.bool(True),
##                                         recordName = cms.string ("Alignments"),
##                                         firstValid = cms.vuint32(1)
##                                         )

## process.EcalSeverityLevelAlgoRcd = cms.ESSource("EmptyESSource",
##                                          iovIsRunNotTime = cms.bool(True),
##                                          recordName = cms.string ("EcalSeverityLevelAlgoRcd"),
##                                          firstValid = cms.vuint32(1)
##                                          )

## process.EcalSeverityLevelAlgo = cms.ESSource("EmptyESSource",
##                                          iovIsRunNotTime = cms.bool(True),
##                                          recordName = cms.string ("EcalSeverityLevelAlgo"),
##                                          firstValid = cms.vuint32(1)
##                                          )
process.TrackingComponentsRecord = cms.ESSource("EmptyESSource",
                                         iovIsRunNotTime = cms.bool(True),
                                         recordName = cms.string ("TrackingComponentsRecord"),
                                         firstValid = cms.vuint32(1)
                                         )
...
#'file:alpha'
'file:EE46A3D4-C2D3-E211-A274-0026189437FA.root'
)
                           )
