...
if usePAT == 'true':
  ...
  process.load('HiggsAnalysis/HiggsToZZ4Leptons/hTozzTo4leptonsPreselection_vbf_data_noskim_cff') 
  ...
  process.hTozzTo4leptonsCommonRootTreePresel.isVBF  = cms.bool(True)
