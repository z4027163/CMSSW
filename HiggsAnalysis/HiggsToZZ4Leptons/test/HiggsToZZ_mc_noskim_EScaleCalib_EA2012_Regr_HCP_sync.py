...
if usePAT == 'true':
  ...
  # Electron Regression
  # process.load("HiggsAnalysis/HiggsToZZ4Leptons/electronRegressionEnergyProducer_cfi")
  ...
  process.load("HiggsAnalysis/HiggsToZZ4Leptons/hTozzTo4leptonsRegressionElectronProducer_cfi")
  # process.hTozzTo4leptonsRegressionElectronProducer.eleCollection = cms.InputTag("gsfElectrons")
        
  process.load("HiggsAnalysis/HiggsToZZ4Leptons/calibratedElectrons_cfi")
  process.calibratedElectrons.inputGsfElectronsTag = cms.InputTag("hTozzTo4leptonsRegressionElectronProducer")
 ...
 # process.calibratedElectrons.applyCorrections = cms.int32(999)
...
process.hTozzTo4leptonsSelectionPath = cms.Path(
  ...
  process.hTozzTo4leptonsRegressionElectronProducer *
