...
config = config()
config.General.requestName = 'Higgs_hzz_13TeV-madgraph-pythia8_Summer16_500' 
...
config.Data.userInputFiles = open('mini_500.txt').readlines()
...
config.Data.outputDatasetTag = 'Higgs_hzz_13TeV-madgraph-pythia8_Summer16_500' 
