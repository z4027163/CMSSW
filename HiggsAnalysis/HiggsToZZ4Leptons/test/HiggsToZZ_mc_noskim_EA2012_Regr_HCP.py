...
if usePAT == 'true':
  ...
  process.calibratedElectronsNoSmeared = calibratedElectrons.clone()
  process.calibratedElectronsNoSmeared.inputElectronsTag = cms.InputTag("gsfElectrons")
  process.calibratedElectronsNoSmeared.isMC = cms.bool(True)
  process.calibratedElectronsNoSmeared.inputDataset = cms.string("Summer12_DR53X_HCP2012")
  process.calibratedElectronsNoSmeared.isAOD = cms.bool(True)
  process.calibratedElectronsNoSmeared.updateEnergyError = cms.bool(True)
  process.calibratedElectronsNoSmeared.debug = cms.bool(True)
  process.calibratedElectronsNoSmeared.applyCorrections = cms.int32(10)
      
  process.load('HiggsAnalysis/HiggsToZZ4Leptons/hTozzTo4leptonsPreselection_data_noskim_cff') 
  process.hTozzTo4leptonsElectronSelector.electronCollection = cms.InputTag("calibratedElectronsNoSmeared","calibratedGsfElectrons")
  # process.vetoElectrons.src = cms.InputTag("gsfElectrons")  
...
process.hTozzTo4leptonsSelectionPath = cms.Path(
  ...
  process.calibratedElectronsNoSmeared *
