...
process.hTozzTo4leptonsMCGenFilterNEW.HZZ4LeptonsMCFilterLeptonFlavour = cms.int32(9)
...
process.ZccGenAnalyzer = cms.EDAnalyzer("ZccGenAnalyzer",
                                        src = cms.InputTag('genParticles')
                                        )

process.p = cms.Path(process.Z * process.c * process.ccCands * process.ccCandscleaned * process.llccCands * process.leptons * process.dileptons * process.trileptons * process.trileptonscleaned * process.fourleptons * process.fourleptonscleaned * process.hTozzTo4leptonsMCGenFilterNEW * process.ZccGenAnalyzer)

# Output definition
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('ZccbarGenAnalysisDY50.root')
                                   )

#process.output = cms.OutputModule("PoolOutputModule",
#                                  fileName = cms.untracked.string('ZccbarGenDY50.root'),
#                                  dataset = cms.untracked.PSet(
#    filterName = cms.untracked.string('ZccFilter')
#    ),
...
process.source = cms.Source("PoolSource",
    ...
    'file:F4BF2B2E-BE9C-E011-976E-001A4BA81FB8.root', ## DYM50
    'file:FE0F6638-C09C-E011-BCCA-001A4BD25578.root', ## DYM50
    'file:FE3430A0-BE9C-E011-AF2D-E0CB4E19F972.root'  ## DYM50    
    ),                            
   )
