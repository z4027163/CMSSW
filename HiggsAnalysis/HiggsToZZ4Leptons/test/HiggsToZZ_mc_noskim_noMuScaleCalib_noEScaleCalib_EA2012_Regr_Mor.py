...
if usePAT == 'true':
  ...
  process.eleRegressionEnergy.verbose = cms.bool(True)
  process.eleRegressionEnergy.synchronization = cms.bool(True)
  process.eleRegressionEnergy.smearingRatio = cms.double(1.0)
