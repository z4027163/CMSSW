{
  ...
  output << "\\hline" << endl;
  sprintf(outputstring,"Observed & %d & %d & %d \\\\",yields4e7TeV[0],yields4mu7TeV[0],yields2e2mu7TeV[0]);
  output << outputstring << endl;
  output << "\\hline \\hline" << endl;
  ...
  output << "\\hline" << endl;
  sprintf(outputstring,"Observed & %d & %d & %d \\\\",yields4e8TeV[0],yields4mu8TeV[0],yields2e2mu8TeV[0]);
  output << outputstring << endl;
  output << "\\hline \\hline" << endl;
  ...
  sprintf(outputstring,"Observed & %d & %d & %d \\\\",yields4eRunI[0],yields4muRunI[0],yields2e2muRunI[0]); 
  output << outputstring << endl;
