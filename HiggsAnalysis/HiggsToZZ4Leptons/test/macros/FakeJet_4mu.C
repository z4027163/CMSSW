...
//	output_txt  << leptformat << endl;
	...
	if (flagFSR==1){
     ...
     int nbtag_pass=0;
     bool lead_jet=false;
     TLorentzVector JET1,JET2,BOT1,BOT2,BOT3;
     ...
     int jet1=-999,jet2=-999,bot1=-999,bot2=-999,bot3=-999;      
     int jetfail[100];
...
//     double btag_weight=1;
     ...
     f_lumi = LumiSection;
       ...
       f_lept1_pt  = RECOMU_PT[0] ;
       f_lept1_eta = RECOMU_ETA[0] ;
       f_lept1_phi = RECOMU_PHI[0];
