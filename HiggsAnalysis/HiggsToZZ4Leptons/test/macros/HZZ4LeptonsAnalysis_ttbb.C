...
//  TGraph *mu_scale_factors_tk = (TGraph*)gDirectory->Get("ratio_eff_eta3_dr030e030_corr");
  ...
  TH1F *b_fk_p4 = (TH1F*)gDirectory->Get("f_ratio_j");
   ...
   //step 3
   TH1F * hMZ_3 = new TH1F("hMZ_3", "Mass of Z after selection step 3", 200 , 0, 200 );
   hMZ_3->SetXTitle("mass_Z  (GeV)");
   TH1F * hPtZ_3 = new TH1F("hPtZ_3", "Pt of Z after selection step 3", 200 , 0, 200 );
   hPtZ_3->SetXTitle("pt_Z  (GeV)");
   TH1F * hYZ_3 = new TH1F("hYZ_3", "Y of Z after selection step 3", 500 , -5. , 5.);
   hYZ_3->SetXTitle("Y_Z");
   
   TH1F * hPtLep_3 = new TH1F("hPtLep_3", "Pt of Lep after selection step 3", 200 , 0, 200 );
	...
	pu_weight=double(puweight->GetBinContent(binx));
     ...
     if(!dm_trig) continue;
      ...
      if( datasetName.Contains("DYBBJetsToLL")||datasetName.Contains("DYJetsToLL")){
        ...
        if(de_trig) bmurate=0.00035;//0.00012;
      }
      if( datasetName.Contains("TT_TuneCUETP8M1")){
        if(dm_trig) bmurate=0.0001;//0.00024;
        if(de_trig) bmurate=0.00036;//0.00019;
      }
...
//        if(nomatch||noleg1) continue;
      ...
      if( datasetName.Contains("DYBBJetsToLL")){
        ...
        if(Z1tag==2) bmurate=0.00035;//0.00012;
      }
      if( datasetName.Contains("TT_TuneCUETP8M1")){
        if(Z1tag==1) bmurate=0.0001;//0.00024;
        if(Z1tag==2) bmurate=0.00036;//0.00019;
      }
...
*/
      ...
      if(MC_type == "Spring17" && DATA_type == "NO" && etaweight){
