...
//  sprintf(nome,"/eos/uscms/store/user/wangz/DoubleMuon/DoubleMuon_Run2016C-03Feb2017-v2_part1/170628_230635/DoubleMuon.root");
  sprintf(nome,"/eos/uscms/store/user/wangz/DoubleMuon/DoubleMuon_Run2016C-03Feb2017-v2_part2/170703_070320/DoubleMuon_0123.root");
  ...
  sprintf(nome,"output_DoubleMuon_0123.root");
  make3.Loop(nome);
