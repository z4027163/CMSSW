  ...
  */
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	//exit(1);
      ...
      //exit(1);
      cout<<"Zcandvector size is: "<<Zcandvector.size()<<endl;
 ...
 // **** Step 8:
    ...
    if (njets_pass<1) {
      ...
      f_jet2_e = RECO_PFJET_ET->at(jet2);
       ...
       JET1new.SetPtEtaPhiE(RECO_PFJET_PT->at(jet1),RECO_PFJET_ETA->at(jet1),RECO_PFJET_PHI->at(jet1),RECO_PFJET_ET->at(jet1)*TMath::CosH(RECO_PFJET_ETA->at(jet1)));
       JET2new.SetPtEtaPhiE(RECO_PFJET_PT->at(jet2),RECO_PFJET_ETA->at(jet2),RECO_PFJET_PHI->at(jet2),RECO_PFJET_ET->at(jet2)*TMath::CosH(RECO_PFJET_ETA->at(jet2)));
