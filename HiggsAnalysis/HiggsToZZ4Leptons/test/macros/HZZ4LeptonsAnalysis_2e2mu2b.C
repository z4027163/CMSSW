...
void HZZ4LeptonsAnalysis::Loop(Char_t *output)
{
   ...
   bool njetrw=false;
   bool pujetrw=true;
   int puid_type=0;  //0 nopuid, 1 loose puid, 2 medium puid, 3 tight puid

   if(era=="BF"){
     pufile="pileup_BF.root";
     puhist="pileup_scale_BF";
     ele_leg1="Leg1_BF_EGM2D.root";
     ele_leg2="Leg2_BF_EGM2D.root";
     id_sf="RunBCDEF_SF_ID.root";
     iso_sf="RunBCDEF_SF_ISO.root";
     mu17_leg="Mu17Leg_SF.root";
     mu8_leg="Mu8Leg_SF.root";
     mu_track="track_BCDEF.root";
     btagcal="CSVv2_94XSF_WP_V2_B_F.csv";
     cout << "era BF" << endl;
   }
...
//pujet reweight qier
   TString pujetsfname="sf_pujet";
   TString pubjetsfname="sf_pubjet";
   double p_pu=0.049;
   double inc_sf=1.90;
//   double p_bpu=0.01;
//   double incb_sf=1.77;
   ...
   if(puid_type==1){
     pujetsfname="sf_pujet_l";
     pubjetsfname="sf_pubjet_l";
     p_pu=0.022;
     inc_sf=2.21;
//     p_bpu=0.0045;
//     incb_sf=1.92;
   ...
   if(puid_type==2){
     pujetsfname="sf_pujet_m";
     pubjetsfname="sf_pubjet_m";
     p_pu=0.006;
     inc_sf=3.32;
   }
   if(puid_type==3){
     pujetsfname="sf_pujet_t";
     pubjetsfname="sf_pubjet_t";
     p_pu=0.003;
     inc_sf=3.3;
   }

   RoccoR  rc("/uscms/home/zwang4/nobackup/WORKSPCACE/ntuple/CMSSW_9_4_13/src/HiggsAnalysis/HiggsToZZ4Leptons/test/macros/roccor/RoccoR2017.txt");
// setup calibration + reader
   ...
   // Load histograms
   //
   TFile *ele_scale_factors_v3 = new TFile("SF_ELE/egammaEffi.txt_EGM2D_runBCDEF_passingRECO.root");
   TH2F *ele_scale_factors_reco = (TH2F*)gDirectory->Get("EGamma_SF2D");

   TFile *ele_scale_factors_v32 = new TFile("SF_ELE/egammaEffi.txt_EGM2D_runBCDEF_passingRECO_lowEt.root");
   TH2F *ele_scale_factors_reco_l = (TH2F*)gDirectory->Get("EGamma_SF2D");

   TFile *ele_scale_factors_v4 = new TFile("SF_ELE/2017_ElectronMVA90.root");
   TH2F *ele_scale_factors_wp90 = (TH2F*)gDirectory->Get("EGamma_SF2D");

   TFile *ele_scale_factors_v1 = new TFile("SF_ELE/iso/"+ele_leg1);
   TH2F *ele_scale_factors_leg1 = (TH2F*)gDirectory->Get("EGamma_SF2D");

   TFile *ele_scale_factors_v2 = new TFile("SF_ELE/iso/"+ele_leg2);
   TH2F *ele_scale_factors_leg2 = (TH2F*)gDirectory->Get("EGamma_SF2D");

   TFile *mu_scale_factors3_p2 = new TFile("SF_GH/"+mu8_leg);
   TH2F *mu_scale_factors_hlt_p2 = (TH2F*)gDirectory->Get("eta_pt_PLOT");
   TH2F *mu_scale_factors_hlt_mc2 = (TH2F*)gDirectory->Get("eta_pt_PLOT_MC");
   TH2F *mu_scale_factors_hlt_data2 = (TH2F*)gDirectory->Get("eta_pt_PLOT_DATA");

   TFile *mu_scale_factors1_p1 = new TFile("SF_GH/"+id_sf);
   TH2F *mu_scale_factors_id_p1 = (TH2F*)gDirectory->Get("NUM_LooseID_DEN_genTracks_pt_abseta");


   TFile *mu_scale_factors2_p1 = new TFile("SF_GH/"+iso_sf);
   TH2F *mu_scale_factors_iso_p1 = (TH2F*)gDirectory->Get("NUM_LooseRelIso_DEN_LooseID_pt_abseta");

   TFile *mu_scale_factors3_p1 = new TFile("SF_GH/"+mu17_leg);
   TH2F *mu_scale_factors_hlt_p1 = (TH2F*)gDirectory->Get("eta_pt_PLOT");
  TH2F *mu_scale_factors_hlt_mc1 = (TH2F*)gDirectory->Get("eta_pt_PLOT_MC");
  TH2F *mu_scale_factors_hlt_data1 = (TH2F*)gDirectory->Get("eta_pt_PLOT_DATA");
...
//   TFile *b_scale_factors3_p3 = new TFile("btag/QCD_all.root");
  ...
  TFile *pujet_scale_factors = new TFile("SF_GH/sf_pujet.root");
  TH1F *pujet_p1 = (TH1F*)gDirectory->Get(pujetsfname);
  TH1F *pujet_p2 = (TH1F*)gDirectory->Get(pubjetsfname);
   ...
   double un_jer[9]={0.0222,0.0484,0.0456,0.1397,0.1470,0.0976,0.1909,0.1501,0.2020};
   double scale_jer[9]={1.1432,1.1815,1.0989,1.1137,1.1307,1.1600,1.2393,1.2604,1.4085};
   ...
   TH1F * hMZ1_5 = new TH1F("hMZ1_5", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5 = new TH1F("hPtZ1_5", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   hPtZ1_5->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_5 = new TH1F("hYZ1_5", "Y of Z1 after selection step 5", 500 , -5. , 5.);
   hYZ1_5->SetXTitle("Y_Z1");

   TH1F * hMZ1_5_pdf_up = new TH1F("hMZ1_5_pdf_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_5_pdf_up = new TH1F("hPtZ1_5_pdf_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_5_pdf_up = new TH1F("hYZ1_5_pdf_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_5_pdf_dow = new TH1F("hMZ1_5_pdf_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_5_pdf_dow = new TH1F("hPtZ1_5_pdf_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_5_pdf_dow = new TH1F("hYZ1_5_pdf_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_5_pu_up = new TH1F("hMZ1_5_pu_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_5_pu_up = new TH1F("hPtZ1_5_pu_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_5_pu_up = new TH1F("hYZ1_5_pu_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_5_pu_dow = new TH1F("hMZ1_5_pu_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_5_pu_dow = new TH1F("hPtZ1_5_pu_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_5_pu_dow = new TH1F("hYZ1_5_pu_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);


   TH1F * hMZ1_5_mc_1 = new TH1F("hMZ1_5_mc_1", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_1->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_1 = new TH1F("hPtZ1_5_mc_1", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_2 = new TH1F("hMZ1_5_mc_2", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_2->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_2 = new TH1F("hPtZ1_5_mc_2", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_3 = new TH1F("hMZ1_5_mc_3", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_3->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_3 = new TH1F("hPtZ1_5_mc_3", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_4 = new TH1F("hMZ1_5_mc_4", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_4->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_4 = new TH1F("hPtZ1_5_mc_4", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_5 = new TH1F("hMZ1_5_mc_5", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_5 = new TH1F("hPtZ1_5_mc_5", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_6 = new TH1F("hMZ1_5_mc_6", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_6->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_6 = new TH1F("hPtZ1_5_mc_6", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_7 = new TH1F("hMZ1_5_mc_7", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_7->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_7 = new TH1F("hPtZ1_5_mc_7", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_5_mc_8 = new TH1F("hMZ1_5_mc_8", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_5_mc_8->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_5_mc_8 = new TH1F("hPtZ1_5_mc_8", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5 = new TH1F("hMZ2_5", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5 = new TH1F("hPtZ2_5", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   hPtZ2_5->SetXTitle("pt_Z2  (GeV)");
   TH1F * hYZ2_5 = new TH1F("hYZ2_5", "Y of Z2 after selection step 5", 500 , -5. , 5. );
   hYZ2_5->SetXTitle("Y_Z2");

   TH1F * hMZ2_5_pdf_up = new TH1F("hMZ2_5_pdf_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_5_pdf_up = new TH1F("hPtZ2_5_pdf_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_5_pdf_up = new TH1F("hYZ2_5_pdf_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_5_pdf_dow = new TH1F("hMZ2_5_pdf_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_5_pdf_dow = new TH1F("hPtZ2_5_pdf_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_5_pdf_dow = new TH1F("hYZ2_5_pdf_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_5_pu_up = new TH1F("hMZ2_5_pu_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_5_pu_up = new TH1F("hPtZ2_5_pu_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_5_pu_up = new TH1F("hYZ2_5_pu_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_5_pu_dow = new TH1F("hMZ2_5_pu_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_5_pu_dow = new TH1F("hPtZ2_5_pu_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_5_pu_dow = new TH1F("hYZ2_5_pu_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_5_mc_1 = new TH1F("hMZ2_5_mc_1", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_1->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_1 = new TH1F("hPtZ2_5_mc_1", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_2 = new TH1F("hMZ2_5_mc_2", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_2->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_2 = new TH1F("hPtZ2_5_mc_2", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_3 = new TH1F("hMZ2_5_mc_3", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_3->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_3 = new TH1F("hPtZ2_5_mc_3", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_4 = new TH1F("hMZ2_5_mc_4", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_4->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_4 = new TH1F("hPtZ2_5_mc_4", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_5 = new TH1F("hMZ2_5_mc_5", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_5->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_5 = new TH1F("hPtZ2_5_mc_5", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_6 = new TH1F("hMZ2_5_mc_6", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_6->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_6 = new TH1F("hPtZ2_5_mc_6", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_7 = new TH1F("hMZ2_5_mc_7", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_7->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_7 = new TH1F("hPtZ2_5_mc_7", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_5_mc_8 = new TH1F("hMZ2_5_mc_8", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_5_mc_8->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_5_mc_8 = new TH1F("hPtZ2_5_mc_8", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5 = new TH1F("hMZee_5", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5 = new TH1F("hPtZee_5", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_pdf_up = new TH1F("hMZee_5_pdf_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_5_pdf_up = new TH1F("hPtZee_5_pdf_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_5_pdf_up = new TH1F("hYZee_5_pdf_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_5_pdf_dow = new TH1F("hMZee_5_pdf_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_5_pdf_dow = new TH1F("hPtZee_5_pdf_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_5_pdf_dow = new TH1F("hYZee_5_pdf_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_5_pu_up = new TH1F("hMZee_5_pu_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_5_pu_up = new TH1F("hPtZee_5_pu_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_5_pu_up = new TH1F("hYZee_5_pu_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_5_pu_dow = new TH1F("hMZee_5_pu_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_5_pu_dow = new TH1F("hPtZee_5_pu_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_5_pu_dow = new TH1F("hYZee_5_pu_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_5_mc_1 = new TH1F("hMZee_5_mc_1", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_1->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_1 = new TH1F("hPtZee_5_mc_1", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_2 = new TH1F("hMZee_5_mc_2", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_2->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_2 = new TH1F("hPtZee_5_mc_2", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_3 = new TH1F("hMZee_5_mc_3", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_3->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_3 = new TH1F("hPtZee_5_mc_3", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_4 = new TH1F("hMZee_5_mc_4", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_4->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_4 = new TH1F("hPtZee_5_mc_4", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_5 = new TH1F("hMZee_5_mc_5", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_5->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_5 = new TH1F("hPtZee_5_mc_5", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_6 = new TH1F("hMZee_5_mc_6", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_6->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_6 = new TH1F("hPtZee_5_mc_6", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_7 = new TH1F("hMZee_5_mc_7", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_7->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_7 = new TH1F("hPtZee_5_mc_7", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_5_mc_8 = new TH1F("hMZee_5_mc_8", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_5_mc_8->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_5_mc_8 = new TH1F("hPtZee_5_mc_8", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5 = new TH1F("hMZmm_5", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5 = new TH1F("hPtZmm_5", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_pdf_up = new TH1F("hMZmm_5_pdf_up", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_5_pdf_up = new TH1F("hPtZmm_5_pdf_up", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_5_pdf_up = new TH1F("hYZmm_5_pdf_up", "Y of Zmm after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_5_pdf_dow = new TH1F("hMZmm_5_pdf_dow", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_5_pdf_dow = new TH1F("hPtZmm_5_pdf_dow", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_5_pdf_dow = new TH1F("hYZmm_5_pdf_dow", "Y of Zmm after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_5_pu_up = new TH1F("hMZmm_5_pu_up", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_5_pu_up = new TH1F("hPtZmm_5_pu_up", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_5_pu_up = new TH1F("hYZmm_5_pu_up", "Y of Zmm after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_5_pu_dow = new TH1F("hMZmm_5_pu_dow", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_5_pu_dow = new TH1F("hPtZmm_5_pu_dow", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_5_pu_dow = new TH1F("hYZmm_5_pu_dow", "Y of Zmm after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_5_mc_1 = new TH1F("hMZmm_5_mc_1", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_1->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_1 = new TH1F("hPtZmm_5_mc_1", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_2 = new TH1F("hMZmm_5_mc_2", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_2->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_2 = new TH1F("hPtZmm_5_mc_2", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_3 = new TH1F("hMZmm_5_mc_3", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_3->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_3 = new TH1F("hPtZmm_5_mc_3", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_4 = new TH1F("hMZmm_5_mc_4", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_4->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_4 = new TH1F("hPtZmm_5_mc_4", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_5 = new TH1F("hMZmm_5_mc_5", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_5->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_5 = new TH1F("hPtZmm_5_mc_5", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_6 = new TH1F("hMZmm_5_mc_6", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_6->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_6 = new TH1F("hPtZmm_5_mc_6", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_7 = new TH1F("hMZmm_5_mc_7", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_7->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_7 = new TH1F("hPtZmm_5_mc_7", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_5_mc_8 = new TH1F("hMZmm_5_mc_8", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_5_mc_8->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_5_mc_8 = new TH1F("hPtZmm_5_mc_8", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6 = new TH1F("hMZee_6", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6 = new TH1F("hPtZee_6", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_pdf_up = new TH1F("hMZee_6_pdf_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_6_pdf_up = new TH1F("hPtZee_6_pdf_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_6_pdf_up = new TH1F("hYZee_6_pdf_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_6_pdf_dow = new TH1F("hMZee_6_pdf_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_6_pdf_dow = new TH1F("hPtZee_6_pdf_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_6_pdf_dow = new TH1F("hYZee_6_pdf_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_6_pu_up = new TH1F("hMZee_6_pu_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_6_pu_up = new TH1F("hPtZee_6_pu_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_6_pu_up = new TH1F("hYZee_6_pu_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_6_pu_dow = new TH1F("hMZee_6_pu_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_6_pu_dow = new TH1F("hPtZee_6_pu_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_6_pu_dow = new TH1F("hYZee_6_pu_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_6_mc_1 = new TH1F("hMZee_6_mc_1", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_1->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_1 = new TH1F("hPtZee_6_mc_1", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_2 = new TH1F("hMZee_6_mc_2", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_2->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_2 = new TH1F("hPtZee_6_mc_2", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_3 = new TH1F("hMZee_6_mc_3", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_3->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_3 = new TH1F("hPtZee_6_mc_3", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_4 = new TH1F("hMZee_6_mc_4", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_4->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_4 = new TH1F("hPtZee_6_mc_4", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_5 = new TH1F("hMZee_6_mc_5", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_5->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_5 = new TH1F("hPtZee_6_mc_5", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_6 = new TH1F("hMZee_6_mc_6", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_6->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_6 = new TH1F("hPtZee_6_mc_6", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_7 = new TH1F("hMZee_6_mc_7", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_7->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_7 = new TH1F("hPtZee_6_mc_7", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_6_mc_8 = new TH1F("hMZee_6_mc_8", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_6_mc_8->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_6_mc_8 = new TH1F("hPtZee_6_mc_8", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6 = new TH1F("hMZmm_6", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6 = new TH1F("hPtZmm_6", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_pdf_up = new TH1F("hMZmm_6_pdf_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_6_pdf_up = new TH1F("hPtZmm_6_pdf_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_6_pdf_up = new TH1F("hYZmm_6_pdf_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_6_pdf_dow = new TH1F("hMZmm_6_pdf_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_6_pdf_dow = new TH1F("hPtZmm_6_pdf_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_6_pdf_dow = new TH1F("hYZmm_6_pdf_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_6_pu_up = new TH1F("hMZmm_6_pu_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_6_pu_up = new TH1F("hPtZmm_6_pu_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_6_pu_up = new TH1F("hYZmm_6_pu_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_6_pu_dow = new TH1F("hMZmm_6_pu_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_6_pu_dow = new TH1F("hPtZmm_6_pu_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_6_pu_dow = new TH1F("hYZmm_6_pu_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_6_mc_1 = new TH1F("hMZmm_6_mc_1", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_1->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_1 = new TH1F("hPtZmm_6_mc_1", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_2 = new TH1F("hMZmm_6_mc_2", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_2->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_2 = new TH1F("hPtZmm_6_mc_2", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_3 = new TH1F("hMZmm_6_mc_3", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_3->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_3 = new TH1F("hPtZmm_6_mc_3", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_4 = new TH1F("hMZmm_6_mc_4", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_4->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_4 = new TH1F("hPtZmm_6_mc_4", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_5 = new TH1F("hMZmm_6_mc_5", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_5->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_5 = new TH1F("hPtZmm_6_mc_5", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_6 = new TH1F("hMZmm_6_mc_6", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_6->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_6 = new TH1F("hPtZmm_6_mc_6", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_7 = new TH1F("hMZmm_6_mc_7", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_7->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_7 = new TH1F("hPtZmm_6_mc_7", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_6_mc_8 = new TH1F("hMZmm_6_mc_8", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_6_mc_8->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_6_mc_8 = new TH1F("hPtZmm_6_mc_8", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7 = new TH1F("hMZee_7", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7 = new TH1F("hPtZee_7", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_pdf_up = new TH1F("hMZee_7_pdf_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_7_pdf_up = new TH1F("hPtZee_7_pdf_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_7_pdf_up = new TH1F("hYZee_7_pdf_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_7_pdf_dow = new TH1F("hMZee_7_pdf_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_7_pdf_dow = new TH1F("hPtZee_7_pdf_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_7_pdf_dow = new TH1F("hYZee_7_pdf_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_7_pu_up = new TH1F("hMZee_7_pu_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_7_pu_up = new TH1F("hPtZee_7_pu_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_7_pu_up = new TH1F("hYZee_7_pu_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_7_pu_dow = new TH1F("hMZee_7_pu_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZee_7_pu_dow = new TH1F("hPtZee_7_pu_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZee_7_pu_dow = new TH1F("hYZee_7_pu_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZee_7_mc_1 = new TH1F("hMZee_7_mc_1", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_1->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_1 = new TH1F("hPtZee_7_mc_1", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_2 = new TH1F("hMZee_7_mc_2", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_2->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_2 = new TH1F("hPtZee_7_mc_2", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_3 = new TH1F("hMZee_7_mc_3", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_3->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_3 = new TH1F("hPtZee_7_mc_3", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_4 = new TH1F("hMZee_7_mc_4", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_4->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_4 = new TH1F("hPtZee_7_mc_4", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_5 = new TH1F("hMZee_7_mc_5", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_5->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_5 = new TH1F("hPtZee_7_mc_5", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_6 = new TH1F("hMZee_7_mc_6", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_6->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_6 = new TH1F("hPtZee_7_mc_6", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_7 = new TH1F("hMZee_7_mc_7", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_7->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_7 = new TH1F("hPtZee_7_mc_7", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZee_7_mc_8 = new TH1F("hMZee_7_mc_8", "Mass of Zee after selection step 5", 200 , 0, 200 );
   hMZee_7_mc_8->SetXTitle("mass_Zee  (GeV)");
   TH1F * hPtZee_7_mc_8 = new TH1F("hPtZee_7_mc_8", "Pt of Zee after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7 = new TH1F("hMZmm_7", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7 = new TH1F("hPtZmm_7", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_pdf_up = new TH1F("hMZmm_7_pdf_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_7_pdf_up = new TH1F("hPtZmm_7_pdf_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_7_pdf_up = new TH1F("hYZmm_7_pdf_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_7_pdf_dow = new TH1F("hMZmm_7_pdf_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_7_pdf_dow = new TH1F("hPtZmm_7_pdf_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_7_pdf_dow = new TH1F("hYZmm_7_pdf_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_7_pu_up = new TH1F("hMZmm_7_pu_up", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_7_pu_up = new TH1F("hPtZmm_7_pu_up", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_7_pu_up = new TH1F("hYZmm_7_pu_up", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_7_pu_dow = new TH1F("hMZmm_7_pu_dow", "Mass of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hPtZmm_7_pu_dow = new TH1F("hPtZmm_7_pu_dow", "Pt of Zee after selection step 5", 200 , 0, 200 );
   TH1F * hYZmm_7_pu_dow = new TH1F("hYZmm_7_pu_dow", "Y of Zee after selection step 5", 500 , -5. , 5.);

   TH1F * hMZmm_7_mc_1 = new TH1F("hMZmm_7_mc_1", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_1->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_1 = new TH1F("hPtZmm_7_mc_1", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_2 = new TH1F("hMZmm_7_mc_2", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_2->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_2 = new TH1F("hPtZmm_7_mc_2", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_3 = new TH1F("hMZmm_7_mc_3", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_3->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_3 = new TH1F("hPtZmm_7_mc_3", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_4 = new TH1F("hMZmm_7_mc_4", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_4->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_4 = new TH1F("hPtZmm_7_mc_4", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_5 = new TH1F("hMZmm_7_mc_5", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_5->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_5 = new TH1F("hPtZmm_7_mc_5", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_6 = new TH1F("hMZmm_7_mc_6", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_6->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_6 = new TH1F("hPtZmm_7_mc_6", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_7 = new TH1F("hMZmm_7_mc_7", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_7->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_7 = new TH1F("hPtZmm_7_mc_7", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZmm_7_mc_8 = new TH1F("hMZmm_7_mc_8", "Mass of Zmm after selection step 5", 200 , 0, 200 );
   hMZmm_7_mc_8->SetXTitle("mass_Zmm  (GeV)");
   TH1F * hPtZmm_7_mc_8 = new TH1F("hPtZmm_7_mc_8", "Pt of Zmm after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hPtEle1_5 = new TH1F("hPtEle1_5", "Pt of Ele1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hPtEle2_5 = new TH1F("hPtEle2_5", "Pt of Ele2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hPtMu1_5 = new TH1F("hPtMu1_5", "Pt of Mu1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hPtMu2_5 = new TH1F("hPtMu2_5", "Pt of Mu2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6 = new TH1F("hMZ1_6", "Mass of Z1 after Z1 selection", 200 , 0, 200 );
   hMZ1_6->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6 = new TH1F("hPtZ1_6", "Pt of Z1 after Z1 selection", 200 , 0, 200 );
   hPtZ1_6->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_6 = new TH1F("hYZ1_6", "Y of Z1 after Z1 selection", 500 , -5. , 5.);
   hYZ1_6->SetXTitle("Y_Z1");

   TH1F * hMZ1_6_pdf_up = new TH1F("hMZ1_6_pdf_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_6_pdf_up = new TH1F("hPtZ1_6_pdf_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_6_pdf_up = new TH1F("hYZ1_6_pdf_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_6_pdf_dow = new TH1F("hMZ1_6_pdf_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_6_pdf_dow = new TH1F("hPtZ1_6_pdf_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_6_pdf_dow = new TH1F("hYZ1_6_pdf_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_6_pu_up = new TH1F("hMZ1_6_pu_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_6_pu_up = new TH1F("hPtZ1_6_pu_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_6_pu_up = new TH1F("hYZ1_6_pu_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_6_pu_dow = new TH1F("hMZ1_6_pu_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_6_pu_dow = new TH1F("hPtZ1_6_pu_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_6_pu_dow = new TH1F("hYZ1_6_pu_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_6_mc_1 = new TH1F("hMZ1_6_mc_1", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_1->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_1 = new TH1F("hPtZ1_6_mc_1", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_2 = new TH1F("hMZ1_6_mc_2", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_2->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_2 = new TH1F("hPtZ1_6_mc_2", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_3 = new TH1F("hMZ1_6_mc_3", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_3->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_3 = new TH1F("hPtZ1_6_mc_3", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_4 = new TH1F("hMZ1_6_mc_4", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_4->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_4 = new TH1F("hPtZ1_6_mc_4", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_5 = new TH1F("hMZ1_6_mc_5", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_5 = new TH1F("hPtZ1_6_mc_5", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_6 = new TH1F("hMZ1_6_mc_6", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_6->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_6 = new TH1F("hPtZ1_6_mc_6", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_7 = new TH1F("hMZ1_6_mc_7", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_7->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_7 = new TH1F("hPtZ1_6_mc_7", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_6_mc_8 = new TH1F("hMZ1_6_mc_8", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_6_mc_8->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_6_mc_8 = new TH1F("hPtZ1_6_mc_8", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6 = new TH1F("hMZ2_6", "Mass of Z2 after jj selection", 200 , 0, 200 );
   hMZ2_6->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6 = new TH1F("hPtZ2_6", "Pt of Z2 after jj selection", 200 , 0, 200 );
   hPtZ2_6->SetXTitle("pt_Z2  (GeV)");
   TH1F * hYZ2_6 = new TH1F("hYZ2_6", "Y of Z2 after jj selection", 500 , -5. , 5.);
   hYZ2_6->SetXTitle("Y_Z2");

   TH1F * hMZ2_6_pdf_up = new TH1F("hMZ2_6_pdf_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_6_pdf_up = new TH1F("hPtZ2_6_pdf_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_6_pdf_up = new TH1F("hYZ2_6_pdf_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_6_pdf_dow = new TH1F("hMZ2_6_pdf_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_6_pdf_dow = new TH1F("hPtZ2_6_pdf_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_6_pdf_dow = new TH1F("hYZ2_6_pdf_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_6_pu_up = new TH1F("hMZ2_6_pu_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_6_pu_up = new TH1F("hPtZ2_6_pu_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_6_pu_up = new TH1F("hYZ2_6_pu_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_6_pu_dow = new TH1F("hMZ2_6_pu_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_6_pu_dow = new TH1F("hPtZ2_6_pu_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_6_pu_dow = new TH1F("hYZ2_6_pu_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);
 
   TH1F * hMZ2_6_mc_1 = new TH1F("hMZ2_6_mc_1", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_1->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_1 = new TH1F("hPtZ2_6_mc_1", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_2 = new TH1F("hMZ2_6_mc_2", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_2->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_2 = new TH1F("hPtZ2_6_mc_2", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_3 = new TH1F("hMZ2_6_mc_3", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_3->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_3 = new TH1F("hPtZ2_6_mc_3", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_4 = new TH1F("hMZ2_6_mc_4", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_4->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_4 = new TH1F("hPtZ2_6_mc_4", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_5 = new TH1F("hMZ2_6_mc_5", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_5->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_5 = new TH1F("hPtZ2_6_mc_5", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_6 = new TH1F("hMZ2_6_mc_6", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_6->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_6 = new TH1F("hPtZ2_6_mc_6", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_7 = new TH1F("hMZ2_6_mc_7", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_7->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_7 = new TH1F("hPtZ2_6_mc_7", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_6_mc_8 = new TH1F("hMZ2_6_mc_8", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_6_mc_8->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_6_mc_8 = new TH1F("hPtZ2_6_mc_8", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7 = new TH1F("hMZ1_7", "Mass of Z1 after selection step 7", 200 , 0, 200);
   hMZ1_7->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7 = new TH1F("hPtZ1_7", "Pt of Z1 after selection step 7", 200 , 0, 200);
   hPtZ1_7->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_7 = new TH1F("hYZ1_7", "Y of Z1 after selection step 7", 500 , -5. , 5.);
   hYZ1_7->SetXTitle("Y_Z1");

   TH1F * hMZ1_7_pdf_up = new TH1F("hMZ1_7_pdf_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_7_pdf_up = new TH1F("hPtZ1_7_pdf_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_7_pdf_up = new TH1F("hYZ1_7_pdf_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_7_pdf_dow = new TH1F("hMZ1_7_pdf_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_7_pdf_dow = new TH1F("hPtZ1_7_pdf_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_7_pdf_dow = new TH1F("hYZ1_7_pdf_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_7_pu_up = new TH1F("hMZ1_7_pu_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_7_pu_up = new TH1F("hPtZ1_7_pu_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_7_pu_up = new TH1F("hYZ1_7_pu_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_7_pu_dow = new TH1F("hMZ1_7_pu_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ1_7_pu_dow = new TH1F("hPtZ1_7_pu_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ1_7_pu_dow = new TH1F("hYZ1_7_pu_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_1 = new TH1F("hMZ1_7_mc_1", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_1->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_1 = new TH1F("hPtZ1_7_mc_1", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_2 = new TH1F("hMZ1_7_mc_2", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_2->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_2 = new TH1F("hPtZ1_7_mc_2", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_3 = new TH1F("hMZ1_7_mc_3", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_3->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_3 = new TH1F("hPtZ1_7_mc_3", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_4 = new TH1F("hMZ1_7_mc_4", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_4->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_4 = new TH1F("hPtZ1_7_mc_4", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_5 = new TH1F("hMZ1_7_mc_5", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_5 = new TH1F("hPtZ1_7_mc_5", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_6 = new TH1F("hMZ1_7_mc_6", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_6->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_6 = new TH1F("hPtZ1_7_mc_6", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_7 = new TH1F("hMZ1_7_mc_7", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_7->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_7 = new TH1F("hPtZ1_7_mc_7", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ1_7_mc_8 = new TH1F("hMZ1_7_mc_8", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   hMZ1_7_mc_8->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_7_mc_8 = new TH1F("hPtZ1_7_mc_8", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7 = new TH1F("hMZ2_7", "Mass of Z2 after selection step 7", 200 , 0, 200);
   hMZ2_7->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7 = new TH1F("hPtZ2_7", "Pt of Z2 after selection step 7", 200 , 0, 200);
   hPtZ2_7->SetXTitle("pt_Z2  (GeV)");
   TH1F * hYZ2_7 = new TH1F("hYZ2_7", "Y of Z2 after selection step 7", 500 , -5. , 5.);
   hYZ2_7->SetXTitle("Y_Z2");

   TH1F * hMZ2_7_pdf_up = new TH1F("hMZ2_7_pdf_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_7_pdf_up = new TH1F("hPtZ2_7_pdf_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_7_pdf_up = new TH1F("hYZ2_7_pdf_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_7_pdf_dow = new TH1F("hMZ2_7_pdf_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_7_pdf_dow = new TH1F("hPtZ2_7_pdf_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_7_pdf_dow = new TH1F("hYZ2_7_pdf_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_7_pu_up = new TH1F("hMZ2_7_pu_up", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_7_pu_up = new TH1F("hPtZ2_7_pu_up", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_7_pu_up = new TH1F("hYZ2_7_pu_up", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_7_pu_dow = new TH1F("hMZ2_7_pu_dow", "Mass of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hPtZ2_7_pu_dow = new TH1F("hPtZ2_7_pu_dow", "Pt of Z1 after selection step 5", 200 , 0, 200 );
   TH1F * hYZ2_7_pu_dow = new TH1F("hYZ2_7_pu_dow", "Y of Z1 after selection step 5", 500 , -5. , 5.);

   TH1F * hMZ2_7_mc_1 = new TH1F("hMZ2_7_mc_1", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_1->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_1 = new TH1F("hPtZ2_7_mc_1", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_2 = new TH1F("hMZ2_7_mc_2", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_2->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_2 = new TH1F("hPtZ2_7_mc_2", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_3 = new TH1F("hMZ2_7_mc_3", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_3->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_3 = new TH1F("hPtZ2_7_mc_3", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_4 = new TH1F("hMZ2_7_mc_4", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_4->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_4 = new TH1F("hPtZ2_7_mc_4", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_5 = new TH1F("hMZ2_7_mc_5", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_5->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_5 = new TH1F("hPtZ2_7_mc_5", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_6 = new TH1F("hMZ2_7_mc_6", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_6->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_6 = new TH1F("hPtZ2_7_mc_6", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_7 = new TH1F("hMZ2_7_mc_7", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_7->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_7 = new TH1F("hPtZ2_7_mc_7", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hMZ2_7_mc_8 = new TH1F("hMZ2_7_mc_8", "Mass of Z2 after selection step 5", 200 , 0, 200 );
   hMZ2_7_mc_8->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_7_mc_8 = new TH1F("hPtZ2_7_mc_8", "Pt of Z2 after selection step 5", 200 , 0, 200 );
   ...
   TH1F * hPtLep1_7 = new TH1F("hPtLep1_7", "Pt of Lep1 after selection step 7", 200 , 0, 200 );
   ...
   TH1F * hPtLep2_7 = new TH1F("hPtLep2_7", "Pt of Lep2 after selection step 7", 200 , 0, 200 );
   ...
   TH1F * hPtLep3_7 = new TH1F("hPtLep3_7", "Pt of Lep3 after selection step 7", 200 , 0, 200 );
   ...
   TH1F * hPtLep4_7 = new TH1F("hPtLep4_7", "Pt of Lep4 after selection step 7", 200 , 0, 200 );
   ...
   //step 8
   TH1F * hMZ1_61 = new TH1F("hMZ1_61", "Mass of Z1 after selection step 7", 200 , 0, 200);
   hMZ1_61->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_61 = new TH1F("hPtZ1_61", "Pt of Z1 after selection step 7", 200 , 0, 200);
   hPtZ1_61->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_61 = new TH1F("hYZ1_61", "Y of Z1 after selection step 7", 500 , -5. , 5.);
   hYZ1_61->SetXTitle("Y_Z1");

   TH1F * hMZ2_61 = new TH1F("hMZ2_61", "Mass of Z2 after selection step 7", 200 , 0, 200);
   hMZ2_61->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_61 = new TH1F("hPtZ2_61", "Pt of Z2 after selection step 7", 200 , 0, 200);
   hPtZ2_61->SetXTitle("pt_Z2  (GeV)");
   TH1F * hYZ2_61 = new TH1F("hYZ2_61", "Y of Z2 after selection step 7", 500 , -5. , 5.);
   hYZ2_61->SetXTitle("Y_Z2");

   TH1F * hMZ1_62 = new TH1F("hMZ1_62", "Mass of Z1 after selection step 7", 200 , 0, 200);
   hMZ1_62->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_62 = new TH1F("hPtZ1_62", "Pt of Z1 after selection step 7", 200 , 0, 200);
   hPtZ1_62->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_62 = new TH1F("hYZ1_62", "Y of Z1 after selection step 7", 500 , -5. , 5.);
   hYZ1_62->SetXTitle("Y_Z1");

   TH1F * hMZ2_62 = new TH1F("hMZ2_62", "Mass of Z2 after selection step 7", 200 , 0, 200);
   hMZ2_62->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_62 = new TH1F("hPtZ2_62", "Pt of Z2 after selection step 7", 200 , 0, 200);
   hPtZ2_62->SetXTitle("pt_Z2  (GeV)");
   TH1F * hYZ2_62 = new TH1F("hYZ2_62", "Y of Z2 after selection step 7", 500 , -5. , 5.);
   hYZ2_62->SetXTitle("Y_Z2");

   TH1F * hPtLep1_8 = new TH1F("hPtLep1_8", "Pt of Lep1 after selection step 8", 200 , 0, 200 );
   ...
   TH1F * hPtLep2_8 = new TH1F("hPtLep2_8", "Pt of Lep2 after selection step 8", 200 , 0, 200 );
   ...
   TH1F * hPtLep3_8 = new TH1F("hPtLep3_8", "Pt of Lep3 after selection step 8", 200 , 0, 200 );
   ...
   TH1F * hPtLep4_8 = new TH1F("hPtLep4_8", "Pt of Lep4 after selection step 8", 200 , 0, 200 );
   ...
   TH1D * hNjets_1 = new TH1D("hNjets_1", "Number of jets passing VBF", 10, -0.5, 9.5);
   TH1D * hNjets_2 = new TH1D("hNjets_2", "Number of jets passing VBF", 10, -0.5, 9.5);

   TH1D * hNjets_pu = new TH1D("hNjets_pu", "Number of jets passing VBF", 10, -0.5, 9.5);
   TH1D * hNjets_1_pu = new TH1D("hNjets_1_pu", "Number of jets passing VBF", 10, -0.5, 9.5);
   ...
   TH1F * hPtJet_11 = new TH1F("hPtJet_11", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   hPtJet_11->SetXTitle("leading pt_jet  (GeV)");


   TH1F * hPtJet_1 = new TH1F("hPtJet_1", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   hPtJet_1->SetXTitle("leading pt_jet  (GeV)");

   TH1F * hPtJet_12 = new TH1F("hPtJet_12", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   TH1F * hPtJet_13 = new TH1F("hPtJet_13", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   TH1F * hPtJet_14 = new TH1F("hPtJet_14", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );

   TH1F * hPtJet_2 = new TH1F("hPtJet_2", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   hPtJet_2->SetXTitle("sub-leading pt_jet  (GeV)");

   TH1F * hPtJet_22 = new TH1F("hPtJet_22", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   TH1F * hPtJet_23 = new TH1F("hPtJet_23", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   TH1F * hPtJet_24 = new TH1F("hPtJet_24", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );

   TH1F * hPtJet_3 = new TH1F("hPtJet_3", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   hPtJet_3->SetXTitle("match pt_jet  (GeV)");

   TH1F * hPtJet_4 = new TH1F("hPtJet_4", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   hPtJet_4->SetXTitle("non-match pt_jet  (GeV)");

   TH1F * hPtBot_3 = new TH1F("hPtBot_3", "Pt of (no ID)bjet after selection step 5", 300 ,  0 , 600 );
   hPtBot_3->SetXTitle("match pt_{b}  (GeV)");

   TH1F * hPtBot_4 = new TH1F("hPtBot_4", "Pt of (no ID)bjet after selection step 5", 300 ,  0 , 600 );
   hPtBot_4->SetXTitle("non-match pt_{b}  (GeV)");

   TH1F * hPtJet_51 = new TH1F("hPtJet_51", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   TH1F * hPtJet_52 = new TH1F("hPtJet_52", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
   TH1F * hPtJet_53 = new TH1F("hPtJet_53", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );

   TH1F * hPtJet_33 = new TH1F("hPtJet_33", "Pt of (no ID)jet after selection step 5", 300 ,  0 , 600 );
...
//      if (!(Run==274422 && LumiSection==484 && Event==843958845)) continue;
      ...
      if( RECO_NMU > 50 ) RECO_NMU = 50;
      if( RECO_NELE > 50 ) RECO_NELE = 50;
	...
	pu_weight=double(puweight->GetBinContent(binx));
      ...
      if (MC_type == "Spring17"){
       ...
       double NG_test=0;
        for(int k=0;k<50;k++){
           if(MC_GENJET_PT[k]<-900) continue;
           if(abs(MC_GENJET_ETA[k])<2.4 && MC_GENJET_PT[k]>30) NG_test++;
           if(MC_GENJET_PT[k]<0) MC_GENJET_PT[k]=-MC_GENJET_PT[k];
           if(abs(MC_GENJET_ETA[k])<2.4 && MC_GENJET_PT[k]>30){
           bool lepmatch=false;
             for(int ll=0; ll<2; ll++){
                for(int kk=1;kk<3;kk++){
                 if(MC_Z_PT[ll][kk]<0) continue;
                 double dRR=10;
                 dRR = sqrt( pow( DELTAPHI( MC_GENJET_PHI[k] , MC_Z_PHI[ll][kk] ),2) + pow(MC_GENJET_ETA[k] - MC_Z_ETA[ll][kk],2) );
                 if(dRR<0.2) lepmatch=true;
             }}
          if(!lepmatch) Ngenjet++;
          //qier test
          if(lepmatch) MC_GENJET_PT[k]=-999;
        }
         if(debug) cout << "GenJet=" << Ngenjet << endl;
        }
         //k factor from SMP-17-005 
       hfit_pdf_up->Fill(NG_test,newweight);
       hfit_pdf_dow->Fill(Ngenjet,newweight);
       if(datasetName.Contains("ZZTo4L")||datasetName.Contains("GluGluTo4L")){
         if(njetrw){
...
//      if(dm_trig||!de_trig) continue;  //de
	...
	bool BDT_ok = 0; // Spring17 with CMSSW_8_0_x

  // MVA V2 iso

        double EB1_10=0.97177-1.97124*exp(-RECOELE_PT[i]/8.91285);
        double EB2_10=0.94587-2.4085*exp(-RECOELE_PT[i]/8.83104);
        double EE_10=0.8979-4.17156*exp(-RECOELE_PT[i]/9.81408);

        //qier chenge to wp90
        if( fabs(RECOELE_scl_Eta[i]) < .8 && RECOELE_mvaTrigV0[i] > EB1_10 ) BDT_ok = 1 ;
        if( fabs(RECOELE_scl_Eta[i]) >= .8 &&fabs(RECOELE_scl_Eta[i])<1.479 && RECOELE_mvaTrigV0[i] > EB2_10 ) BDT_ok = 1 ;
        if(fabs(RECOELE_scl_Eta[i])>=1.479 && RECOELE_mvaTrigV0[i] > EE_10) BDT_ok=1;
...
//          if(de_trig&&pTcleanedgoodZ.at(i).tag==pTcleanedgoodZ.at(j).tag) continue;
  ...
  //    if(!((Z1tag==1&&Z2tag==2)||(Z1tag==2&&Z2tag==1))) continue; 
     ...
     TLorentzVector L1P4,L2P4,L3P4,L4P4;
	  ...
	  if( MC_type == "Spring17" && DATA_type == "NO"){
            int biny1 = mu_scale_factors_id_p1->GetYaxis()->FindBin(abs(Eta));
            int binx1 = mu_scale_factors_id_p1->GetXaxis()->FindBin(Pt);

            double sf_id=mu_scale_factors_id_p1->GetBinContent(binx1,biny1);
            if (sf_id>0.) eff_weight*=sf_id;

            int biny2 = mu_scale_factors_iso_p1->GetYaxis()->FindBin(abs(Eta));
            int binx2 = mu_scale_factors_iso_p1->GetXaxis()->FindBin(Pt);
	...
	for(int i = 0; i < 2; ++i){
	  ...
	  if( MC_type == "Spring17" && DATA_type == "NO"){
            ...
            if(Pt>=20){
              ...
              int biny4 = ele_scale_factors_reco_l->GetYaxis()->FindBin(Pt);
              int binx4 = ele_scale_factors_reco_l->GetXaxis()->FindBin(Eta);
              if (ele_scale_factors_reco_l->GetBinContent(binx4,biny4)>0.) eff_weight*=ele_scale_factors_reco_l->GetBinContent(binx4,biny4);
              if(debug) cout << "ele reco sf = " << ele_scale_factors_reco_l->GetBinContent(binx4,biny4) << endl;
    ...
    for(int i=0; i<2; i++){
       if( MC_type == "Spring17" && DATA_type == "NO"){
          ...
          if(RECOMU_dm_MuHLTMatch[indextwomu[i]]== 2){
            ...
            int binx3 = mu_scale_factors_hlt_p1->GetXaxis()->FindBin(Eta);
...
//            double sf_hlt = mu_scale_factors_hlt_p1->GetBinContent(binx3,biny3)*19.666/35.812+mu_scale_factors_hlt_p2->GetBinContent(binx32,biny32)*16.146/35.812;
            ...
            int biny32 = mu_scale_factors_hlt_p2->GetYaxis()->FindBin(Pt);
            int binx32 = mu_scale_factors_hlt_p2->GetXaxis()->FindBin(Eta);
...
//de_trig matching(qier)
    ...
    if( MC_type == "Spring17" && DATA_type == "NO"){
     ...
     bool muleadpt=false;
      ...
      for(int i=0; i<2; i++){
            if(debug) cout << indextwomu[i] << endl;
            Double_t Pt = RECOMU_PT[indextwomu[i]];
            Double_t Eta = RECOMU_ETA[indextwomu[i]];

            if(Pt>20) muleadpt=true;
            if(Pt>20){
            int biny3 = mu_scale_factors_hlt_mc1->GetYaxis()->FindBin(Pt);
            int binx3 = mu_scale_factors_hlt_mc1->GetXaxis()->FindBin(abs(Eta));

            mcmuleg1[i] = mu_scale_factors_hlt_mc1->GetBinContent(binx3,biny3);
            muleg1[i] = mcmuleg1[i]*mu_scale_factors_hlt_p1->GetBinContent(binx3,biny3);
            }
            int biny32 = mu_scale_factors_hlt_mc2->GetYaxis()->FindBin(Pt);
            int binx32 = mu_scale_factors_hlt_mc2->GetXaxis()->FindBin(abs(Eta));

            mcmuleg2[i] = mu_scale_factors_hlt_mc2->GetBinContent(binx32,biny32);
            muleg2[i] = mcmuleg2[i]*mu_scale_factors_hlt_p2->GetBinContent(binx32,biny32);
 ...
 */
	...
	if (flagFSR==1){
     ...
     int njets_pass=0,npu_pass=0,npu_1_pass=0;
     int nbtag_pass=0;
     TLorentzVector JET1,JET2,JET3,BOT1,BOT2;
     ...
     bool b1=false;
     bool b2=false;
     int jet1=-999,jet2=-999,jet3=-999,bot1=-999,bot2=-999;      
     int jetfail[50];
     ...
     for(int i=0;i<50;i++) jetfail[i]=0;
     ...
     for(int i=0;i<RECO_PFJET_N;i++){
       ...
       if(puid_type!=0){
         double puidmva1=-10;
         double puidmva2=-10;
         if(puid_type==1){ puidmva1=-0.97; puidmva2=-0.89;}
         if(puid_type==2){ puidmva1=0.18; puidmva2=0.61;}
         if(puid_type==3){ puidmva1=0.69; puidmva2=0.86;}

         if(RECO_PFJET_PT[i]<30&&RECO_PFJET_PUID_MVA[i]<puidmva1) continue;
         if(RECO_PFJET_PT[i]>=30 && RECO_PFJET_PT[i]< 50 && RECO_PFJET_PUID_MVA[i]<puidmva2) continue;
       }
...
//    	   if (fabs(RECOELE_SIP[iLe[ele]])>=4.) continue;
	 ...
	 if (jetfail[i]==0){
	   ...
	   njets_pass++;
           ...
           if(!match_jet && MC_type == "Spring17" && DATA_type == "NO") {
            npu_pass++; if(RECO_PFJET_PT[i]<45) npu_1_pass++;
}
           double pujet_sf=1;
           if(pujetrw && !match_jet && MC_type == "Spring17" && DATA_type == "NO"){
            if(RECO_PFJET_PT[i]>25&&RECO_PFJET_PT[i]<45){
             int pubinx = pujet_p1->GetXaxis()->FindBin(RECO_PFJET_PT[i]);
             if(cSV_BTagJet_DISCR[i]> 0.5803) pujet_sf=pujet_p2->GetBinContent(pubinx);
             else pujet_sf=pujet_p1->GetBinContent(pubinx);
             if(pujet_sf<0) pujet_sf=1;

             double isf,ppu;
       //      if(cSV_BTagJet_DISCR[i]> 0.5803) {ppu=p_bpu; isf=incb_sf;}
             ppu=p_pu; isf=inc_sf;
             npujetweight=npujetweight*pujet_sf/(1+(isf-1)*ppu);//(1+p_pu*(pujet_sf-1));
           }}

           hPtJet_8->Fill(RECO_PFJET_PT[i],newweight*pujet_sf);
           hYJet_8->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf);
           hPtJet_8_up->Fill(RECO_PFJET_PT_UP[i],newweight*pujet_sf);
           hPtJet_8_dow->Fill(RECO_PFJET_PT_DOW[i],newweight*pujet_sf);

           hPtJet_8_pdf_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*(1+PDF_weighting_un));
           hPtJet_8_pdf_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*(1-PDF_weighting_un));
           hPtJet_8_pu_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*pu_up);
           hPtJet_8_pu_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*pu_dow);

           hYJet_8_pdf_up->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*(1+PDF_weighting_un));
           hYJet_8_pdf_dow->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*(1-PDF_weighting_un));

           hPtJet_8_jer_up->Fill(RECO_PFJET_PT[i]*jer_scale_up,newweight*pujet_sf);
           hPtJet_8_jer_dow->Fill(RECO_PFJET_PT[i]*jer_scale_dow,newweight*pujet_sf);

           hPtJet_8_mc_1->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[1]);
           hYJet_8_mc_1->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[1]);

           hPtJet_8_mc_2->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[2]);
           hYJet_8_mc_2->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[2]);

           hPtJet_8_mc_3->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[3]);
           hYJet_8_mc_3->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[3]);

           hPtJet_8_mc_4->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[4]);
           hYJet_8_mc_4->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[4]);

           hPtJet_8_mc_5->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[5]);
           hYJet_8_mc_5->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[5]);

           hPtJet_8_mc_6->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[6]);
           hYJet_8_mc_6->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[6]);

           hPtJet_8_mc_7->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[7]);
           hYJet_8_mc_7->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[7]);

           hPtJet_8_mc_8->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*mc_weight_un[8]);
           hYJet_8_mc_8->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*mc_weight_un[8]);
           ...
           if(cSV_BTagJet_DISCR[i]> 0.5803){
              ...
              if( MC_type == "Spring17" && DATA_type == "NO"){
                 if(RECOBOT_MatchingMCTruth[i+1]==2){
                    ...
                    hPtBot_8_c->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
                    hPtBot_8_c_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_up);
                    hPtBot_8_c_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_dow);
                    ...
                    hPtBot_8_b->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
                    hPtBot_8_b_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_up);
                    hPtBot_8_b_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_dow);
                    scale_h_up+=(scaleFactor_up/scaleFactor-1)*(scaleFactor_up/scaleFactor-1);
                    scale_h_dow+=(1-scaleFactor_dow/scaleFactor)*(1-scaleFactor_dow/scaleFactor);
...
//                    if( datasetName.Contains("ZZTo4L")|| datasetName.Contains("GluGluTo")) sf_l=b_eff_zz_p5->GetBinContent(binxb);
                    ...
                    hPtBot_8_l->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
                    hPtBot_8_l_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_up);
                    hPtBot_8_l_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_dow);
                    ...
                    hPtBot_8_o->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
                    hPtBot_8_o_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_up);
                    hPtBot_8_o_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor_dow);
                    scale_l_up+=(scaleFactor_up/scaleFactor-1)*(scaleFactor_up/scaleFactor-1);
                    scale_l_dow+=(1-scaleFactor_dow/scaleFactor)*(1-scaleFactor_dow/scaleFactor);
                 }
             ...
             hPtBot_8->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
             hPtBot_8_up->Fill(RECO_PFJET_PT_UP[i],newweight*pujet_sf*scaleFactor);
             hPtBot_8_dow->Fill(RECO_PFJET_PT_DOW[i],newweight*pujet_sf*scaleFactor);
             hPtBot_8_pdf_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*(1+PDF_weighting_un));
             hPtBot_8_pdf_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*(1-PDF_weighting_un));
             hPtBot_8_pu_up->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*pu_up);
             hPtBot_8_pu_dow->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*pu_dow);
             hPtBot_8_jer_up->Fill(RECO_PFJET_PT[i]*jer_scale_up,newweight*pujet_sf);
             hPtBot_8_jer_dow->Fill(RECO_PFJET_PT[i]*jer_scale_dow,newweight*pujet_sf);

             hPtBot_8_mc_1->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[1]);
             hPtBot_8_mc_2->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[2]);
             hPtBot_8_mc_3->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[3]);
             hPtBot_8_mc_4->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[4]);
             hPtBot_8_mc_5->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[5]);
             hPtBot_8_mc_6->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[6]);
             hPtBot_8_mc_7->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[7]);
             hPtBot_8_mc_8->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor*mc_weight_un[8]);

           hYBot_8->Fill(RECO_PFJET_ETA[i],newweight*scaleFactor);
             if( MC_type == "Spring17" && DATA_type == "NO"){
               if(match_jet) hPtBot_3->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
               else hPtBot_4->Fill(RECO_PFJET_PT[i],newweight*pujet_sf*scaleFactor);
             }
             ...
             if( MC_type == "Spring17" && DATA_type == "NO"){
              ...
              if(scaleFactor<0) scaleFactor=0;
               ...
               if(match_jet) hPtJet_3->Fill(RECO_PFJET_PT[i],newweight*pujet_sf);
               else hPtJet_4->Fill(RECO_PFJET_PT[i],newweight*pujet_sf);
          }
	   ...
	   if (njets_pass==1){
	     ...
	     JET_PHI_PT_MAX=RECO_PFJET_PHI[i];
             bdiscr_5_lead->Fill(cSV_BTagJet_DISCR[i],newweight*pujet_sf);
	   ...
	   if (njets_pass==2){
	     ...
	     JET2.SetPtEtaPhiE(RECO_PFJET_PT[i],RECO_PFJET_ETA[i],RECO_PFJET_PHI[i],RECO_PFJET_ET[i]*TMath::CosH(RECO_PFJET_ETA[i]));
             ...
             bdiscr_5_sub->Fill(cSV_BTagJet_DISCR[i],newweight*pujet_sf);
	   }
           if (njets_pass==3){
             jet3=i;
           ...
           //b-tagging
           if (nbtag_pass==1&&cSV_BTagJet_DISCR[i]> 0.5803){
             bot1=i;
           ...
           if (nbtag_pass==2&&cSV_BTagJet_DISCR[i]> 0.5803){
             bot2=i;
...
//powheg to nlo correction for ZZ qier
      if (MC_type == "Spring17"&&(datasetName.Contains("ZZTo4L"))){
          if(njets_pass>2) newweight=newweight*1.2;
      }

     hNjets_pu->Fill(npu_pass,newweight);
     hNjets_1_pu->Fill(npu_1_pass,newweight);
     hNjets_1->Fill(njets_pass,newweight*npujetweight);
     hNjets_2->Fill(njets_pass,newweight);
     newweight=newweight*npujetweight;
     if(njets_pass==1) hPtJet_11->Fill(JET1.Pt(),newweight);
     if(njets_pass==3)
     {hPtJet_33->Fill(JET1.Pt(),newweight);
      hPtJet_33->Fill(JET2.Pt(),newweight);
      hPtJet_33->Fill(JET3.Pt(),newweight);}
