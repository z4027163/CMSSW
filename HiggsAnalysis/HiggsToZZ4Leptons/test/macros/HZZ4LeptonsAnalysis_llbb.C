...
//#define p_pu 0.022//0.05
//#define inc_sf 2.31//1.93
...
//  TGraph *mu_scale_factors_tk = (TGraph*)gDirectory->Get("ratio_eff_eta3_dr030e030_corr");
  ...
  TFile *z_scale_factors = new TFile("SF_GH/genZpt_2017_2016.root");
  TH1F *z_sf_p1 = (TH1F*)gDirectory->Get("sf_Zmm");
  TH1F *z_sf_p2 = (TH1F*)gDirectory->Get("sf_zee");
  ...
  TH1F *pujet_p2 = (TH1F*)gDirectory->Get(pubjetsfname);
   ...
   TH1F * hMZ1_5_cal = new TH1F("hMZ1_5_cal", "Mass of Z1 after selection step 5", 200 , 0. , 200. );

   TH1F * hMZ1_5_cal_up = new TH1F("hMZ1_5_cal_up", "Mass of Z1 after selection step 5", 200 , 0. , 200. );

   TH1F * hMZ1_5_cal_dow = new TH1F("hMZ1_5_cal_dow", "Mass of Z1 after selection step 5", 200 , 0. , 200. );
   ...
   TH1F * hMZ1_BB_5 = new TH1F("hMZ1_BB_5", "Mass of Z1 after selection step 5 BB", 200 , 0. , 200. );
   hMZ1_BB_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_BB_5 = new TH1F("hPtZ1_BB_5", "Pt of Z1 after selection step 5 BB", 200 , 0. , 200. );
   hPtZ1_BB_5->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_BB_5 = new TH1F("hYZ1_BB_5", "Y of Z1 after selection step 5 BB", 500 , -5. , 5.);
   hYZ1_5->SetXTitle("Y_Z1");

   TH1F * hMZ1_EB_5 = new TH1F("hMZ1_5_EB", "Mass of Z1 after selection step 5 EB", 200 , 0. , 200. );
   hMZ1_EB_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_EB_5 = new TH1F("hPtZ1_EB_5", "Pt of Z1 after selection step 5 EB", 200 , 0. , 200. );
   hPtZ1_EB_5->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_EB_5 = new TH1F("hYZ1_EB_5", "Y of Z1 after selection step 5 EB", 500 , -5. , 5.);
   hYZ1_5->SetXTitle("Y_Z1");

   TH1F * hMZ1_EE_5 = new TH1F("hMZ1_EE_5", "Mass of Z1 after selection step 5 EE", 200 , 0. , 200. );
   hMZ1_EE_5->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_EE_5 = new TH1F("hPtZ1_EE_5", "Pt of Z1 after selection step 5 EE", 200 , 0. , 200. );
   ...
   TH1F * hPtLep1_5 = new TH1F("hPtLep1_5", "Pt of Lep1 after selection step 5", 200 , 0. , 200. );
   ...
   TH1F * hPtLep2_5 = new TH1F("hPtLep2_5", "Pt of Lep2 after selection step 5", 200 , 0. , 200. );
   ...
   TH1F * hPtLep3_5 = new TH1F("hPtLep3_5", "Pt of Lep3 after selection step 5", 200 , 0. , 200. );
   ...
   TH1F * hPtLep4_5 = new TH1F("hPtLep4_5", "Pt of Lep4 after selection step 5", 200 , 0. , 200. );
   ...
   TH1F * hMZ1 = new TH1F("hMZ1", "Mass of Z1 after Z1 selection", 200 , 0. , 200. );
   hMZ1->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1 = new TH1F("hPtZ1_6", "Pt of Z1 after Z1 selection", 200 , 0. , 200. );
   ...
   TH1F * hMZ1_7_pdf_up = new TH1F("hMZ1_7_pdf_up", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_pdf_up = new TH1F("hPtZ1_7_pdf_up", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_pdf_up = new TH1F("hYZ1_7_pdf_up", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_pdf_dow = new TH1F("hMZ1_7_pdf_dow", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_pdf_dow = new TH1F("hPtZ1_7_pdf_dow", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_pdf_dow = new TH1F("hYZ1_7_pdf_dow", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_pu_up = new TH1F("hMZ1_7_pu_up", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_pu_up = new TH1F("hPtZ1_7_pu_up", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_pu_up = new TH1F("hYZ1_7_pu_up", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_pu_dow = new TH1F("hMZ1_7_pu_dow", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_pu_dow = new TH1F("hPtZ1_7_pu_dow", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_pu_dow = new TH1F("hYZ1_7_pu_dow", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_1 = new TH1F("hMZ1_7_mc_1", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_1 = new TH1F("hPtZ1_7_mc_1", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_1 = new TH1F("hYZ1_7_mc_1", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_2 = new TH1F("hMZ1_7_mc_2", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_2 = new TH1F("hPtZ1_7_mc_2", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_2 = new TH1F("hYZ1_7_mc_2", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_3 = new TH1F("hMZ1_7_mc_3", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_3 = new TH1F("hPtZ1_7_mc_3", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_3 = new TH1F("hYZ1_7_mc_3", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_4 = new TH1F("hMZ1_7_mc_4", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_4 = new TH1F("hPtZ1_7_mc_4", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_4 = new TH1F("hYZ1_7_mc_4", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_5 = new TH1F("hMZ1_7_mc_5", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_5 = new TH1F("hPtZ1_7_mc_5", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_5 = new TH1F("hYZ1_7_mc_5", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_6 = new TH1F("hMZ1_7_mc_6", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_6 = new TH1F("hPtZ1_7_mc_6", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_6 = new TH1F("hYZ1_7_mc_6", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_7 = new TH1F("hMZ1_7_mc_7", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_7 = new TH1F("hPtZ1_7_mc_7", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hYZ1_7_mc_7 = new TH1F("hYZ1_7_mc_7", "Y of Z1 after selection step 7", 500 , -5. , 5.);

   TH1F * hMZ1_7_mc_8 = new TH1F("hMZ1_7_mc_8", "Mass of Z1 after selection step 7", 200 , 0. , 200. );
   TH1F * hPtZ1_7_mc_8 = new TH1F("hPtZ1_7_mc_8", "Pt of Z1 after selection step 7", 200 , 0. , 200. );
   ...
   TH1F * hMZ1_8 = new TH1F("hMZ1_8", "Mass of Z1 after selection step 8", 200 , 0. , 200. );
   hMZ1_8->SetXTitle("mass_Z1  (GeV)");
   TH1F * hPtZ1_8 = new TH1F("hPtZ1_8", "Pt of Z1 after selection step 8", 200 , 0. , 200. );
   hPtZ1_8->SetXTitle("pt_Z1  (GeV)");
   TH1F * hYZ1_8 = new TH1F("hYZ1_8", "Y of Z1 after selection step 8", 500 , -5. , 5.);
   hYZ1_8->SetXTitle("Y_Z1");

   TH1F * hMZ2_8 = new TH1F("hMZ2_8", "Mass of Z2 after selection step 8", 200 , 0. , 200. );
   hMZ2_8->SetXTitle("mass_Z2  (GeV)");
   TH1F * hPtZ2_8 = new TH1F("hPtZ2_8", "Pt of Z2 after selection step 8", 200 , 0. , 200. );
   ...
   TH1F * hMjj_8 = new TH1F("hMjj_8", "Mass jets vbf selection step 8", 200, -0, 500 );
   hMjj_8->SetXTitle("Mass jets");

   //no FSR   
   TH1F * hMZ1_noFSR_8 = new TH1F("hMZ1_noFSR_8", "Mass of Z1 after selection step 8 _noFSR", 200 , 0. , 200. );
   hMZ1_8->SetXTitle("mass_Z1  (GeV)");
   TH1F * hMZ2_noFSR_8 = new TH1F("hMZ2_noFSR_8", "Mass of Z2 after selection step 8 _noFSR", 200 , 0. , 200. );
   hMZ2_8->SetXTitle("mass_Z2  (GeV)");
 ...
 TH1F * hDPHI_JET_MET_8 = new TH1F("hDPHI_JET_MET_8", "polar angle between jet and E_{T,miss}", 3150, 0., 3.15 );
   ...
   TH2F * Jet1_vs_Jet2 = new TH2F("Jet1_vs_Jet2", "Jet1Pt vs Jet2pt",300, 0,300,300,0,300 );

   TH1F *hJet_low_NHF = new TH1F("hJet_low_NHF","NHF of Jet Pt < 45",100,0,1.);
   TH1F *hJet_low_NEF = new TH1F("hJet_low_NEF","NEF of Jet Pt < 45",100,0,1.);
   TH1F *hJet_low_ncon = new TH1F("hJet_low_ncon","nconstituents of Jet Pt < 45",50,0,50);
   TH1F *hJet_low_NCH = new TH1F("hJet_low_NCH","NCH of Jet Pt < 45",50,0,50);
   TH1F *hJet_low_CHF = new TH1F("hJet_low_CHF","CEF of Jet Pt < 45",100,0,1);
   TH1F *hJet_low_CEF = new TH1F("hJet_low_CEF","CEF of Jet Pt < 45",100,0,1);
   TH1F *hJet_low_MUF = new TH1F("hJet_low_MUF","MUF of Jet Pt < 45",100,0,1);
   TH1F *hJet_low_HF = new TH1F("hJet_low_HF","HF of Jet Pt < 45",100,0,2);
   TH1F *hJet_low_EF = new TH1F("hJet_low_EF","EF of Jet Pt < 45",100,0,2);
   TH1F *hJet_low_allF= new TH1F("hJet_low_allF","EF of Jet Pt < 45",200,0,4);

   TH1F *hJet_high_NHF = new TH1F("hJet_high_NHF","NHF of Jet Pt > 45",100,0,1.);
   TH1F *hJet_high_NEF = new TH1F("hJet_high_NEF","NEF of Jet Pt > 45",100,0,1.);
   TH1F *hJet_high_ncon = new TH1F("hJet_high_ncon","nconstituents of Jet Pt > 45",50,0,50);
   TH1F *hJet_high_NCH = new TH1F("hJet_high_NCH","NCH of Jet Pt > 45",50,0,50);
   TH1F *hJet_high_CHF = new TH1F("hJet_high_CHF","CHF of Jet Pt > 45",100,0,1);   
   TH1F *hJet_high_CEF = new TH1F("hJet_high_CEF","CEF of Jet Pt > 45",100,0,1);
   TH1F *hJet_high_MUF = new TH1F("hJet_high_MUF","MUF of Jet Pt > 45",100,0,1);
   TH1F *hJet_high_HF = new TH1F("hJet_high_HF","HF of Jet Pt > 45",100,0,2);
   TH1F *hJet_high_EF = new TH1F("hJet_high_EF","EF of Jet Pt > 45",100,0,2);
   TH1F *hJet_high_allF= new TH1F("hJet_high_allF","EF of Jet Pt > 45",200,0,4);

   TH1F * hYJet_low_8 = new TH1F("hEtaJet_low_8", "Y of jet Pt < 45", 500 , -5. , 5. );
   TH1F * hYJet_high_8 = new TH1F("hEtaJet_high_8", "Y of jet Pt > 45", 500 , -5. , 5. );
   ...
   TH1F * hPtJet_pu_8 = new TH1F("hPtJet_pu_8", "Pt of pu jet after selection step 5", 300 ,  0 , 600 );
   ...
   TH2F * Zpt_vs_genZ = new TH2F("Zpt_vs_genZ", "Zpt vs genZpt",50, 0,250,50,0,250 );
   Zpt_vs_genZ->SetXTitle("genZ P_{t}(GeV)");
   Zpt_vs_genZ->SetYTitle("recoZ P_{t}(GeV)");

   TH1I * hJet_low_PUID = new TH1I("hJet_low_PUID", "PUID of jet pt < 45GeV", 2,0,2);
   hJet_low_PUID->SetXTitle("PUID");

   TH1F * hJet_low_PUID_MVA = new TH1F("hJet_low_PUID_MVA", "PUID MVA after step 5", 100,-1,1);
   hJet_low_PUID_MVA->SetXTitle("PUID_MVA");

   TH1I * hJet_high_PUID = new TH1I("hJet_high_PUID", "PUID of jet pt < 45GeV", 2,0,2);
   hJet_high_PUID->SetXTitle("PUID");

   TH1F * hJet_high_PUID_MVA = new TH1F("hJet_high_PUID_MVA", "PUID MVA after step 5", 100,-1,1);
   hJet_high_PUID_MVA->SetXTitle("PUID_MVA");
   ...
   TH1F * dR_low_l = new TH1F("dR_low_l", "dR of low jet to closest lep", 100 , 0. , 5. );
   TH1F * dR_high_l = new TH1F("dR_high_l", "dR of high pt jet to closest lep", 100 , 0. , 5. );

   TH1D * hNGenJet = new TH1D("hNGenJet", "Number of genjets", 10, -0.5, 9.5);
   hNGenJet->SetXTitle("# genjets");
   TH1D * hNGenJet_w = new TH1D("hNGenJet_w", "Number of genjets", 10, -0.5, 9.5);
   hNGenJet_w->SetXTitle("# genjets");

   TH1D * hNGenJet_5 = new TH1D("hNGenJet_5", "Number of genjets", 10, -0.5, 9.5);
   hNGenJet_5->SetXTitle("# genjets");
   TH1D * hNGenJet_5_w = new TH1D("hNGenJet_5_w", "Number of genjets", 10, -0.5, 9.5);
   hNGenJet_5_w->SetXTitle("# genjets");

   TH1F * hPtGenJet_5 = new TH1F("hPtGenJet_5", "Pt of genjet after selection step 5", 300 ,  0 , 600 );
   hPtGenJet_5->SetXTitle("pt_j  (GeV)");
...
//Bottom plot
   ...
   TH1D * hNPU_8 = new TH1D("hNPU_8", "Number of jets passing VBF", 6, 0.5, 6.5);
   TH1D * hNPU_n = new TH1D("hNPU_n", "Number of jets passing VBF", 6, 0.5, 6.5);
   TH1D * hNPU_d = new TH1D("hNPU_d", "Number of jets passing VBF", 6, 0.5, 6.5);
...
//        zptweight=true;
      ...
      double pu_dow=1;
      int pu_bin=0;
      if (MC_type == "Spring17"||MC_type == "Summer17"){
	...
	pu_weight=double(puweight->GetBinContent(binx));
        ...
        pu_bin=int(num_PU_vertices/10.0);	
        //cout << "pu=" << num_PU_vertices << " pu_bin=" << pu_bin << endl;
      }      
      ...
      if (DATA_type=="NO"&&MC_type == "Spring17"){
       double Ngenjet=0;
       double NG_test=0;
        for(int k=0;k<50;k++){
           if(MC_GENJET_PT[k]<-900) continue;
           if(MC_GENJET_PT[k]<0) MC_GENJET_PT[k]=-MC_GENJET_PT[k];
           if(abs(MC_GENJET_ETA[k])<2.4 && MC_GENJET_PT[k]>25) {Ngenjet++;
           bool lepmatch=false;
       ...
       hNGenJet->Fill(NG_test,newweight);
       hNGenJet_w->Fill(Ngenjet,newweight);
     }
      ...
      if(debug) cout << "de_trig=" << de_trig << endl;
      // ** Step 0.1:
      // number of 4L (4mu)...
 	...
 	if(/* ( RECOMU_isGlobalMu[i] || (RECOMU_isTrackerMu[i] && RECOMU_numberOfMatches[i]>0) )
	  ...
	  if( RECOMU_PFX_dB[i] > max_Iso_loose_mu ) max_Iso_loose_mu = RECOMU_PFX_dB[i] ;
        ...
        for(int j=0;j<RECO_PFJET_N;j++){
             ...
             bool goodjet = RECO_PFJET_NHF[j] < 0.90 &&
                      RECO_PFJET_NEF[j] < 0.90 &&
                      RECO_PFJET_CHF[j] >0 &&
 ...
 //             RECOMU_isMedium[i] &&//mediumID
      ...
      for( int i = 0; i < RECO_NELE; ++i ){
        ...
        if( debug ) cout << "\n Electron i="<< i <<" properties: "
		  ...
		  << "\nfabs(RECOELE_scl_Eta[i]) " << fabs(RECOELE_scl_Eta[i])
      		  ...
      		  << "\nRECOELE_mvaTrigV0[i] " << RECOELE_mvaTrigV0[i]
		  << "\nfabs( RECOELE_gsftrack_dxy[i] ) " << fabs( RECOELE_gsftrack_dxy[i] )
      		  << "\nfabs( RECOELE_gsftrack_dz[i] ) " << fabs( RECOELE_gsftrack_dz[i] )
		  << endl ;
 	...
 	if( RECOELE_PT[i] > 10. && fabs(RECOELE_ETA[i]) < 2.5 );
	  // && RECOELE_gsftrack_expected_inner_hits[i]<=1 ) /* ok */ ;
        ...
        Ne_loose_4++;
        mva_ele->Fill(RECOELE_mvaTrigV0[i],newweight);

	bool BDT_ok = 0; // Spring17 with CMSSW_9_4_x

//WP90 definition see RecoEgamma/ElectronIdentification/python/Identification/mvaElectronID_Fall17_iso_V2_cff.py   //which is bullshit
//https://rembserj.web.cern.ch/rembserj/notes/Electron_MVA_ID_2017_documentation/
  //MVA V2 noniso
/*
        double EB1_10=0.917-3.139*exp(-RECOELE_PT[i]/8.75794);
        double EB2_10=0.9319-3.5985*exp(-RECOELE_PT[i]/8.84605);
        double EE_10=0.8899-4.3528*exp(-RECOELE_PT[i]/10.12423);
*/
  // MVA V2 iso
   ...
   //wp80
/*
        double EB1_10=0.98966-0.402042*exp(-RECOELE_PT[i]/10.3425);
        double EB2_10=0.981923-0.772675*exp(-RECOELE_PT[i]/9.05549);
        double EE_10=0.962510-2.29162*exp(-RECOELE_PT[i]/8.425893);
*/
        //qier chenge to wp90
...
//        if (Zcandvector.at(index).massvalue <50  || (Zcandvector.at(index).massvalue > 70 && Zcandvector.at(index).massvalue < 110)) continue;
...
//            double sf_hlt = mu_scale_factors_hlt_p1->GetBinContent(binx3,biny3)*19.666/35.812+mu_scale_factors_hlt_p2->GetBinContent(binx32,biny32)*16.146/35.812;
      ...
      if( MC_type == "Spring17" && DATA_type == "NO" && zptweight){
...
//2016->2017 genZ correction
        if(MC_Z_PT[0][0]<150){
         zbinx = z_sf_p2->GetXaxis()->FindBin(MC_Z_PT[0][0]);
         if(debug) cout <<"zbin=" << zbinx <<endl;
         sf_z=z_sf_p2->GetBinContent(zbinx);
        }
        }
       if(abs(MC_Z_PDGID[0][1])==13&&MC_Z_PT[0][0]>=0){
        ...
        else if(MC_Z_PT[0][0]<65) newweight=newweight*0.955;
        else if(MC_Z_PT[0][0]<85) newweight=newweight*0.97;
        else if(MC_Z_PT[0][0]<150) newweight=newweight*1;
//2016->2017 genZ correction
        if(MC_Z_PT[0][0]<150){  
         zbinx = z_sf_p1->GetXaxis()->FindBin(MC_Z_PT[0][0]);
      //   if(jentry>4850000) cout << "jentry=" << jentry << " zbinx=" << zbinx << " sf_z=" << sf_z << endl;
         sf_z=z_sf_p1->GetBinContent(zbinx);
         }
        }
      if(ptZ1<5 && MC_Z_PT[0][0]<0) sf_z=1.5;
      newweight=newweight/sf_z;

      if(MC_Z_PT[0][0]>=0){
        Zpt_vs_genZ->Fill(MC_Z_PT[0][0],ptZ1);
       }
      }
...
//this part for electron calibration uncertainty
     if(Z1tag==2){
       TLorentzVector E1, E2, E1_up, E2_up,E1_dow,E2_dow; 
       E1.SetPtEtaPhiM(RECOELE_PT[indexlep1Z1], RECOELE_ETA[indexlep1Z1], RECOELE_PHI[indexlep1Z1], 0.000511);
       E2.SetPtEtaPhiM(RECOELE_PT[indexlep2Z1], RECOELE_ETA[indexlep2Z1], RECOELE_PHI[indexlep2Z1], 0.000511);
       double e1_up=1, e2_up=1, e1_dow=1, e2_dow=1;
       if( MC_type == "NO" && DATA_type == "2017"){ 
         e1_up=RECOELE_energyScaleUp[indexlep1Z1]/RECOELE_E[indexlep1Z1];
         e1_dow=RECOELE_energyScaleDown[indexlep1Z1]/RECOELE_E[indexlep1Z1];
         e2_up=RECOELE_energyScaleUp[indexlep2Z1]/RECOELE_E[indexlep2Z1];
         e2_dow=RECOELE_energyScaleDown[indexlep2Z1]/RECOELE_E[indexlep2Z1];
       }
       if(  MC_type == "Spring17" && DATA_type == "NO"){
         e1_up=RECOELE_energySigmaUp[indexlep1Z1]/RECOELE_E[indexlep1Z1];
         e1_dow=RECOELE_energySigmaDown[indexlep1Z1]/RECOELE_E[indexlep1Z1];
         e2_up=RECOELE_energySigmaUp[indexlep2Z1]/RECOELE_E[indexlep2Z1];
         e2_dow=RECOELE_energySigmaDown[indexlep2Z1]/RECOELE_E[indexlep2Z1];
       }
       if(debug && ((e1_up==1&&e1_dow==1)||(e2_up==1&&e2_dow==1))) cout << "e1_up=" << e1_up << " e1_dow=" << e1_dow << " e2_up="<<e2_up << " e2_dow=" << e2_dow << endl;
       E1_up.SetPtEtaPhiM(RECOELE_PT[indexlep1Z1]*e1_up, RECOELE_ETA[indexlep1Z1], RECOELE_PHI[indexlep1Z1], 0.000511);
       E2_up.SetPtEtaPhiM(RECOELE_PT[indexlep2Z1]*e2_up, RECOELE_ETA[indexlep2Z1], RECOELE_PHI[indexlep2Z1], 0.000511);
       E1_dow.SetPtEtaPhiM(RECOELE_PT[indexlep1Z1]*e1_dow, RECOELE_ETA[indexlep1Z1], RECOELE_PHI[indexlep1Z1], 0.000511);
       E2_dow.SetPtEtaPhiM(RECOELE_PT[indexlep2Z1]*e2_dow, RECOELE_ETA[indexlep2Z1], RECOELE_PHI[indexlep2Z1], 0.000511);

       hMZ1_5_cal->Fill((E1+E2).M(),newweight);
       hMZ1_5_cal_up->Fill((E1_up+E2_up).M(),newweight);
       hMZ1_5_cal_dow->Fill((E1_dow+E2_dow).M(),newweight);
     }
      ...
      if (DATA_type=="NO"&&MC_type == "Spring17"){
       double Ngenjet=0;
        for(int k=0;k<50;k++){
           ...
           if(abs(MC_GENJET_ETA[k])<2.4 && MC_GENJET_PT[k]>25){ 
            Ngenjet++;
            hPtGenJet_5->Fill(MC_GENJET_PT[k],newweight);
           }
        }
       hNGenJet_5->Fill(Ngenjet);
       hNGenJet_5_w->Fill(Ngenjet,newweight);
     }
	...
	*/
	...
	if (ismuon && flagFSR_tag==0){
	  ...
	  sprintf (leptformat,"FormatLept=%d:%d:%d:%d:%.2f:%.2f:%.2f:%.2f:%.2f:%.2f:%.2f:%.2f:%.3f:%.3f:%.2f:%.2f:%.2f",
		   ...
		   RECOELE_PFchHad[ipt[i]],RECOELE_PFneuHad[ipt[i]],RECOELE_PFphoton[ipt[i]],RHO_ele,RECOELE_PFX_rho[ipt[i]],RECOELE_mvaTrigV0[ipt[i]],
		   RECOPFPHOT_PT[iLp[pfsr]],RECOPFPHOT_DR[iLp[pfsr]],RECOPFPHOT_PFX_rho[iLp[pfsr]]
		   );
	}	
	else if (ismuon){	  	  	      
...
//	output_txt  << leptformat << endl;
	...
	if (flagFSR==1){
     ...
     int puj1=-999, puj2=-999, puj3=-999;
     int jetfail[50];
     ...
     for(int i=0;i<RECO_PFJET_N;i++){
       ...
       bool goodjet = RECO_PFJET_NHF[i] < 0.90 &&
                      ...
                      RECO_PFJET_CHF[i] > 0    &&
                 //     RECO_PFJET_CEF[i] < 0.80 &&
                 //     RECO_PFJET_MUF[i] < 0.80 &&
                      RECO_PFJET_nconstituents[i] > 1 &&
                      RECO_PFJET_NCH[i] > 0 ;
                //      RECO_PFJET_PUID_MVA[i]>-0.6 ; 

       if(RECO_PFJET_PT[i]>25. && fabs(RECO_PFJET_ETA[i])<2.4 && goodjet==1){
         
 //PUID for 30-50   loose: -0.97,-0.89 medium: 0.18,0.61  tight:0.69, 0.86
       if(puid_type!=0){
         double puidmva1=-10;
         double puidmva2=-10;
...
//pujet reweight qier
           if(!match_jet && MC_type == "Spring17" && DATA_type == "NO") {
            ...
            if(npu_pass==1) puj1=i;
            if(npu_pass==2) puj2=i;
            if(npu_pass==3) puj3=i;
}
           double pujet_sf=1;
...
//           npujet+=newweight;
//           npujet_w+=newweight*pujet_sf;
           if(RECO_PFJET_PT[i]>50) lead_jet = true;

           //pu jet qier
           if(RECO_PFJET_PUID_MVA[i]>-0.6) hPtJet_pu_8->Fill(RECO_PFJET_PT[i],newweight);
           ...
           hYJet_8_pu_up->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*pu_up);
           hYJet_8_pu_dow->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*pu_dow);
...
//genjet match
           if( MC_type == "Spring17" && DATA_type == "NO"){
             if(pu_bin<=6&&pu_bin>=1&& RECO_PFJET_PT[i]<45){ 
               if(match_jet) genmatch[pu_bin-1]+=newweight*pujet_sf; 
               numberjet[pu_bin-1]+=newweight*pujet_sf; 
             }
           }    
//jet substructure

           if(RECO_PFJET_PT[i]<45){
             hJet_low_NHF->Fill(RECO_PFJET_NHF[i],newweight*pujet_sf);
             hJet_low_NEF->Fill(RECO_PFJET_NEF[i],newweight*pujet_sf);
             hJet_low_ncon->Fill(RECO_PFJET_nconstituents[i],newweight*pujet_sf);
             hJet_low_NCH->Fill(RECO_PFJET_NCH[i],newweight*pujet_sf);
             hJet_low_CHF->Fill(RECO_PFJET_CHF[i],newweight*pujet_sf);
             hJet_low_CEF->Fill(RECO_PFJET_CEF[i],newweight*pujet_sf);
             hJet_low_MUF->Fill(RECO_PFJET_MUF[i],newweight*pujet_sf);
             hJet_low_PUID->Fill(RECO_PFJET_PUID[i],newweight*pujet_sf);
             hJet_low_PUID_MVA->Fill(RECO_PFJET_PUID_MVA[i],newweight*pujet_sf);
             hJet_low_HF->Fill(RECO_PFJET_CHF[i]+RECO_PFJET_NHF[i],newweight*pujet_sf);
             hJet_low_EF->Fill(RECO_PFJET_CEF[i]+RECO_PFJET_NEF[i],newweight*pujet_sf);
             hJet_low_allF->Fill(RECO_PFJET_CHF[i]+RECO_PFJET_NHF[i]+RECO_PFJET_CEF[i]+RECO_PFJET_NEF[i]+RECO_PFJET_MUF[i],newweight*pujet_sf);
             hYJet_low_8->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf);
           ...
           for(int j=0.;j<Nphotons;j++) {
            ...
            if(drmin<10){
              dR_low_l->Fill(drmin,newweight*pujet_sf);
            }

           }
           else{
             hJet_high_NHF->Fill(RECO_PFJET_NHF[i],newweight*pujet_sf);
             hJet_high_NEF->Fill(RECO_PFJET_NEF[i],newweight*pujet_sf);
             hJet_high_ncon->Fill(RECO_PFJET_nconstituents[i],newweight*pujet_sf);
             hJet_high_NCH->Fill(RECO_PFJET_NCH[i],newweight*pujet_sf);
             hJet_high_CHF->Fill(RECO_PFJET_CHF[i],newweight*pujet_sf);
             hJet_high_CEF->Fill(RECO_PFJET_CEF[i],newweight*pujet_sf);
             hJet_high_MUF->Fill(RECO_PFJET_MUF[i],newweight*pujet_sf);
             hJet_high_PUID->Fill(RECO_PFJET_PUID[i],newweight*pujet_sf);
             hJet_high_PUID_MVA->Fill(RECO_PFJET_PUID_MVA[i],newweight*pujet_sf);
             hJet_high_HF->Fill(RECO_PFJET_CHF[i]+RECO_PFJET_NHF[i],newweight*pujet_sf);
             hJet_high_EF->Fill(RECO_PFJET_CEF[i]+RECO_PFJET_NEF[i],newweight*pujet_sf);
             hJet_high_allF->Fill(RECO_PFJET_CHF[i]+RECO_PFJET_NHF[i]+RECO_PFJET_CEF[i]+RECO_PFJET_NEF[i]+RECO_PFJET_MUF[i],newweight*pujet_sf);
             hYJet_high_8->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf);
           ...
           for(int j=0.;j<Nphotons;j++) {
            ...
            if(drmin<10){
              dR_high_l->Fill(drmin,newweight*pujet_sf);
            }
...
//qier b-tag sf                       else if(datasetName.Contains("TT")) sf_l=b_eff_tt_p5->GetBinContent(binxb);
           ...
           //            cout << "light jet sf=" << reader.eval_auto_bounds("central",BTagEntry::FLAV_UDSG, abs(Eta), Pt) << "\n b jet sf="<<reader.eval_auto_bounds("central",BTagEntry::FLAV_B, Eta, Pt) << endl;
             ...
             hYBot_8->Fill(RECO_PFJET_ETA[i],newweight*pujet_sf*scaleFactor);
    ...
    //         hPtJet_1->Fill(RECO_PFJET_PT[i],newweight*pujet_sf);
	   }
	   if (njets_pass==2){
	     jet2=i;
    ...
    //         hPtJet_2->Fill(RECO_PFJET_PT[i],newweight*pujet_sf);
            if( MC_type == "Spring17" && DATA_type == "NO"){             
             if(match_jet) cat2=1;
             else cat2=2;
             }
...
//     if(njets_pass>=1&&npujet!=0) npujetweight=npujet_w/npujet;
//     else npujetweight=1;
     
//     cout <<"pujet weight=" << npujetweight << endl;
     ...
     if(npu_pass==1) hPtJet_51->Fill(RECO_PFJET_PT[puj1],newweight);
     if(npu_pass==2) {
      hPtJet_52->Fill(RECO_PFJET_PT[puj1],newweight); 
      hPtJet_52->Fill(RECO_PFJET_PT[puj2],newweight);
      Jet1_vs_Jet2->Fill(RECO_PFJET_PT[puj1],RECO_PFJET_PT[puj2],newweight);}
     if(npu_pass==3) {hPtJet_53->Fill(RECO_PFJET_PT[puj1],newweight); hPtJet_53->Fill(RECO_PFJET_PT[puj2],newweight); hPtJet_53->Fill(RECO_PFJET_PT[puj3],newweight);}
     ...
     double jjphi=(JET1+JET2).Phi(); 
     double z1phi=Z1P4.Phi();

/*  
     if(Mjj<70) continue;
     if(DELTAPHI(jjphi,z1phi)<=2.5) continue;
     if(ptZ1<=150) continue;
*/

      hPtJet_1->Fill(JET1.Pt(),newweight);
      hPtJet_2->Fill(JET2.Pt(),newweight);

//     if(njets_pass==2&&JET2.Pt()>50&&npujetweight!=1) cout << "sth wrong" << endl;  
  //   if(njets_pass==2){
     if( MC_type == "Spring17" && DATA_type == "NO"){ 
      if(cat1==1&&cat2==1){
       hPtJet_12->Fill(JET1.Pt(),newweight);
       hPtJet_22->Fill(JET2.Pt(),newweight);
      }
      if((cat1==1&&cat2==2)||(cat1==2&&cat2==1)){
       hPtJet_13->Fill(JET1.Pt(),newweight);
       hPtJet_23->Fill(JET2.Pt(),newweight);
      }
      if(cat1==2&&cat2==2){
       hPtJet_14->Fill(JET1.Pt(),newweight);
       hPtJet_24->Fill(JET2.Pt(),newweight);
      }
     }
 //   }
     ...
     if(nbtag_pass==1){
     if(jet1!=bot1) hPtJet_9->Fill(JET1.Pt(),newweight);
     else  hPtJet_9->Fill(JET2.Pt(),newweight);
     }
...
//sign third jet after 2bot, just for test (qier)
     if(njets_pass<3) continue;
     if(jet1!=bot1&&jet1!=bot2) hPtJet_7->Fill(JET1.Pt(),newweight*nbjetweight);
     else if(jet2!=bot1&&jet2!=bot2) hPtJet_7->Fill(JET2.Pt(),newweight*nbjetweight);
     else  hPtJet_7->Fill(JET3.Pt(),newweight*nbjetweight);
     ...
     if (Z1tag==1){
       ...
       //    f_lept1_mvaid = RECOMU_mvaTrigV0[indexleptonfinal[0]];
       ...
       //    f_lept2_mvaid = RECOMU_mvaTrigV0[indexleptonfinal[1]];
     }
     else if (Z1tag==2) {
       ...
       f_lept1_mvaid = RECOELE_mvaTrigV0[indexleptonfinal[0]];
       ...
       f_lept2_mvaid = RECOELE_mvaTrigV0[indexleptonfinal[1]];
...
//qier genjet match fraction
 if (DATA_type=="NO"&&MC_type == "Spring17"){
   for(int b=1; b<=6; b++) {hNPU_8->SetBinContent(b,genmatch[b-1]/numberjet[b-1]);
      hNPU_n->SetBinContent(b,genmatch[b-1]);
      hNPU_d->SetBinContent(b,numberjet[b-1]);
//      cout << "pu_bin=" << b << " genmatch=" << genmatch[b-1] << " all=" << numberjet[b-1] << endl;
   }}
/*   
   output_txt << "N_0 "  << N_0  << " \n" 
	      << "N_01 " << N_01 << " \n"	
