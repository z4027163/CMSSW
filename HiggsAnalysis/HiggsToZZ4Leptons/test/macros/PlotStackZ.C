...
#define nnn 1.00
#define p_dy 1.0//0.956 0.975 0.99             //nopu lpu mpu
#define p_tt 1.0//0.946 0.962 0.98
using namespace std;
...
//  std::string histolabel = "hMZ1_5_cal";
...
//  std::cout << "Histogram label is= " << histolabel << std::endl;
  ...
  std::string label6[6]={"hPtJet_8","hPtBot_8","hPtJet_1","hPtJet_2","hPtJet_11","hPtJet_33"};
  ...
  std::string labeljet[26]={"hJet_low_NHF","hJet_low_NEF","hJet_low_ncon","hJet_low_NCH","hJet_low_CHF","hJet_low_MUF","hJet_low_CEF","hJet_high_NHF","hJet_high_NEF","hJet_high_ncon","hJet_high_NCH","hJet_high_CHF","hJet_high_MUF","hJet_high_CEF","hJet_low_PUID_MVA","hJet_high_PUID_MVA","hJet_low_HF","hJet_low_EF","hJet_low_allF","hJet_high_HF","hJet_high_EF","hJet_high_allF","hEtaJet_low_8","hEtaJet_high_8","dR_low_l","dR_high_l"};
  un_mc=false;
 ...
 std::string histolabel = "hEtaJet_low_8";
//  plotmZ(histolabel);
...
//   Color_t h400Color = kRed;
  ...
  if (histlabel.find("hJet_low_NHF")<10||histlabel.find("hJet_high_NHF")<10){
    hframe= new TH2F("hframe","hframe",100,0.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 1., 1000, 0.5, 2.0);// mZ1 
    hframe2->SetXTitle("NHF");
  }
  if (histlabel.find("hJet_low_NEF")<10||histlabel.find("hJet_high_NEF")<10){
    hframe= new TH2F("hframe","hframe",100,0.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 1., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("NEF");
  }
  if (histlabel.find("hJet_low_CHF")<10||histlabel.find("hJet_high_CHF")<10){
    hframe= new TH2F("hframe","hframe",100,0.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 1., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("CHF");
  }
  if (histlabel.find("hJet_low_ncon")<10||histlabel.find("hJet_high_ncon")<10){
    hframe= new TH2F("hframe","hframe",50,0.,50,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",50, 0., 50, 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("nconstituents");
  }
  if (histlabel.find("hJet_low_NCH")<10||histlabel.find("hJet_high_NCH")<10){
    hframe= new TH2F("hframe","hframe",50,0.,50,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",50, 0., 50., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("NCH");
  }
  if (histlabel.find("hJet_low_CEF")<10||histlabel.find("hJet_high_CEF")<10){
    hframe= new TH2F("hframe","hframe",100,0.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 1., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("CEF");
  }
  if (histlabel.find("hJet_low_MUF")<10||histlabel.find("hJet_high_MUF")<10){
    hframe= new TH2F("hframe","hframe",100,0.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 1., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("MUF");
  }
  if (histlabel.find("hJet_low_PUID")<10||histlabel.find("hJet_high_PUID")<10){
    hframe= new TH2F("hframe","hframe",2,0.,2.,500,1.0,100000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",2, 0., 2., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("PUID");
  }
  if (histlabel.find("hJet_low_PUID_MVA")<10||histlabel.find("hJet_high_PUID_MVA")<10){
    hframe= new TH2F("hframe","hframe",100,-1.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, -1., 1., 1000, 0.5, 2.0);// mZ1 
    hframe2->SetXTitle("PUID_MVA");
  }
  if (histlabel.find("hJet_low_HF")<10||histlabel.find("hJet_high_HF")<10){
    hframe= new TH2F("hframe","hframe",50,0.,1.,500,1.0,100000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",50, 0., 1., 1000, 0.5, 2.0);// mZ1 
    hframe2->SetXTitle("HF");
  }
  if (histlabel.find("hJet_low_EF")<10||histlabel.find("hJet_high_EF")<10){
    hframe= new TH2F("hframe","hframe",50,0.,1.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",50, 0., 1., 1000, 0.5, 2.0);// mZ1 
    hframe2->SetXTitle("EF");
  }
  if (histlabel.find("hJet_low_allF")<10||histlabel.find("hJet_high_allF")<10){
    hframe= new TH2F("hframe","hframe",100,0.,2.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 2., 1000, 0.5, 2.0);// mZ1 
    hframe2->SetXTitle("allF");
  }
  if (histlabel.find("dR_low_l")<10||histlabel.find("dR_high_l")<10){
    hframe= new TH2F("hframe","hframe",100,0.,5.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",100, 0., 5., 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("dR");
  }

  if (histlabel.find("hMZ1_5")<10){
    hframe= new TH2F("hframe","hframe",xxbin,xxmin,xxmax,500,1.0,60000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",xxbin,xxmin,xxmax, 10000, 0.8, 1.2);// mZ1 
  ...
  if (histlabel.find("hMZ1_7")<10){
    hframe= new TH2F("hframe","hframe",xxbin,xxmin,xxmax,500,1.0,200000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",xxbin,xxmin,xxmax, 1000, 0.5, 1.5);// mZ1 
    hframe2->SetXTitle("M_{ll} [GeV]");
  }
  ...
  if (histlabel.find("hPtJet_1")<10||histlabel.find("hPtJet_2")<10||histlabel.find("hPtJet_11")<10||histlabel.find("hPtJet_33")<10){
    hframe= new TH2F("hframe","hframe",190,20.,400.,500,1.0,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",190, 20., 400., 1000, 0.5, 1.5);// mZ1 
  ...
  if (histlabel.find("hEtaJet_8")<10||histlabel.find("hEtaJet_high_8")<10||histlabel.find("hEtaJet_low_8")<10){
    hframe= new TH2F("hframe","hframe",50,-2.5,2.5,500,1.0,4000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",50, -2.5, 2.5, 1000, 0.7, 1.3);// mZ1 
    hframe2->SetXTitle("#eta_{j}");   
  }
...
//nlo
        hfourlepbestmass_4l_afterSel_new_new->Scale(p_dy*double(6225.4*41526*nnn/(82501188*1.792*10000)));
//madgraph
//        hfourlepbestmass_4l_afterSel_new_new->Scale(double(6225.4*41526*nnn/(48601447)));
	...
	sprintf(temp,"%s",histosdir.c_str());
      ...
      if(datasetnamebkg.find("DYBB") <200 && hfourlepbestmass_4l_afterSel_new_new->GetEntries()>0 ){
        hfourlepbestmass_4l_afterSel_new_new->Scale(double(40.4*41526.*nnn/2554303));
	...
	// WZ     
	if(datasetnamebkg.find("WZ") < 200){ 
          hfourlepbestmass_4l_afterSel_new_new->Scale(double(4.43*41526.*nnn/(10881896.*7.51)));
	  ...
	  char temp[328];
	  sprintf(temp,"%s",histosdir.c_str());
	  if(hfourlepbestmass_4l_afterSel_new_WZ->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F"); 
	  //hfourlepbestmass_4l_afterSel_new_new->Draw("sameP"); 
	}    
	
	// TTT
	if(datasetnamebkg.find("TT_TuneCUETP8M1") < 200){
          hfourlepbestmass_4l_afterSel_new_new->Scale(p_tt*double(831.76*41526*nnn/(61801849*2025.)));
	...
	if(datasetnamebkg.find("_WJetsToLNu") < 200){
	  cout << "Wjets" << endl;
          hfourlepbestmass_4l_afterSel_new_new->Scale(61526.7*41526/(234227690*1.53*100000));
      ...
      //Single Top
        if(datasetnamebkg.find("ST_top_t-channel") < 200){
          ...
          hfourlepbestmass_4l_afterSel_new_new->Scale(double(136.1*41526./5887322.));
      ...
      //Single antitop
        if(datasetnamebkg.find("ST_antitop_t-channel") < 200){
          ...
          hfourlepbestmass_4l_afterSel_new_new->Scale(double(81.0*41526./3775674.));
          hfourlepbestmass_4l_afterSel_new_ST->Add(hfourlepbestmass_4l_afterSel_new_new);
          hfourlepbestmass_4l_afterSel_new_ST->SetMarkerColor(kViolet);
          hfourlepbestmass_4l_afterSel_new_ST->SetFillColor(kViolet);
        }
      ...
      if(datasetnamebkg.find("datadriven") <200 && hfourlepbestmass_4l_afterSel_new_new->GetEntries()>0 ){
        hfourlepbestmass_4l_afterSel_new_new->Scale(1.0);
   ...
   TString file_un="unc/un_all.root";
   TString histname = histlabel.c_str();

   if(un_mc &&histlabel.find("hMZ1_5")<10){
     TFile *f3 = TFile::Open(file_un); 
    
     TH1F *hfourlepbestmass_mc_up = (TH1F*)f3->Get(histname+"_cal_cal_up_rel");
     TH1F *hfourlepbestmass_mc_dow = (TH1F*)f3->Get(histname+"_cal_cal_dow_rel");
