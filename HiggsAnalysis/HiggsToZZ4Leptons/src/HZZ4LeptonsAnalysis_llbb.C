...
#include "../test/macros/roccor/RoccoR.cc"
...
void HZZ4LeptonsAnalysis::Loop(Char_t *output)
{
    ...
    RoccoR  rc("../test/macros/roccor/RoccoR2017.txt"); //directory path as input for now; initialize only once, contains all variations
    ...
    for(uint i = 0; i < cut_PFMET.size(); i++){//initialize the counter
        counter_cut_PFMET.push_back(0);
    }

    for(uint i=0; i< cut_PFMET.size(); i++){
    ...
    Float_t f_weight, f_int_weight, f_pu_weight, f_eff_weight, f_lept1_pt, f_lept1_eta, f_lept1_phi, f_lept1_charge, f_lept1_pfx, f_lept1_sip, f_lept2_pt, f_lept2_eta, f_lept2_phi, f_lept2_charge, f_lept2_pfx, f_lept2_sip, f_lept3_pt, f_lept3_eta, f_lept3_phi, f_lept3_charge, f_lept3_pfx, f_lept3_sip, f_lept4_pt, f_lept4_eta, f_lept4_phi, f_lept4_charge, f_lept4_pfx, f_lept4_sip, f_iso_max, f_sip_max, f_Z1mass, f_Z2mass, f_angle_costhetastar, f_angle_costheta1, f_angle_costheta2, f_angle_phi, f_angle_phistar1, f_eta4l, f_pt4l, f_mass4l, f_mass4lErr, f_njets_pass, f_deltajj, f_massjj, f_D_jet, f_jet1_pt, f_jet1_eta, f_jet1_phi, f_jet1_e, f_jet2_pt, f_jet2_eta, f_jet2_phi, f_jet2_e;
    ...
    Int_t f_category,f_Ngood,f_Nbjets,f_Njets,f_NVBFjets,f_NMatchbjets;
    Int_t f_run, f_lumi, f_event;
    Float_t f_u1,f_u2,f_z1_pt,ff_weight;

    newtree->Branch("f_run", &f_run,"f_run/I");
    newtree->Branch("f_lumi", &f_lumi,"f_lumi/I");    
    newtree->Branch("f_event", &f_event,"f_event/I");    

    newtree->Branch("f_weight", &f_weight,"f_weight/F");
    newtree->Branch("f_int_weight", &f_int_weight,"f_int_weight/F");
    newtree->Branch("f_pu_weight", &f_pu_weight,"f_pu_weight/F");
    newtree->Branch("f_eff_weight", &f_eff_weight,"f_eff_weight/F");
    newtree->Branch("f_lept1_pt", &f_lept1_pt,"f_lept1_pt/F");
    newtree->Branch("f_lept1_eta", &f_lept1_eta,"f_lept1_eta/F");
    newtree->Branch("f_lept1_phi", &f_lept1_phi,"f_lept1_phi/F");
    newtree->Branch("f_lept1_charge", &f_lept1_charge,"f_lept1_charge/F");
    newtree->Branch("f_lept1_pfx", &f_lept1_pfx,"f_lept1_pfx/F");
    newtree->Branch("f_lept1_sip", &f_lept1_sip,"f_lept1_sip/F");
    newtree->Branch("f_lept1_pdgid", &f_lept1_pdgid,"f_lept1_pdgid/I");
    newtree->Branch("f_lept2_pt", &f_lept2_pt,"f_lept2_pt/F");
    newtree->Branch("f_lept2_eta", &f_lept2_eta,"f_lept2_eta/F");
    newtree->Branch("f_lept2_phi", &f_lept2_phi,"f_lept2_phi/F");
    newtree->Branch("f_lept2_charge", &f_lept2_charge,"f_lept2_charge/F");
    newtree->Branch("f_lept2_pfx", &f_lept2_pfx,"f_lept2_pfx/F");
    newtree->Branch("f_lept2_sip", &f_lept2_sip,"f_lept2_sip/F");
    newtree->Branch("f_lept2_pdgid", &f_lept2_pdgid,"f_lept2_pdgid/I");
    newtree->Branch("f_lept3_pt", &f_lept3_pt,"f_lept3_pt/F");
    newtree->Branch("f_lept3_eta", &f_lept3_eta,"f_lept3_eta/F");
    newtree->Branch("f_lept3_phi", &f_lept3_phi,"f_lept3_phi/F");
    newtree->Branch("f_lept3_charge", &f_lept3_charge,"f_lept3_charge/F");
    newtree->Branch("f_lept3_pfx", &f_lept3_pfx,"f_lept3_pfx/F");
    newtree->Branch("f_lept3_sip", &f_lept3_sip,"f_lept3_sip/F");
    newtree->Branch("f_lept3_pdgid", &f_lept3_pdgid,"f_lept3_pdgid/I");
    newtree->Branch("f_lept4_pt", &f_lept4_pt,"f_lept4_pt/F");
    newtree->Branch("f_lept4_eta", &f_lept4_eta,"f_lept4_eta/F");
    newtree->Branch("f_lept4_phi", &f_lept4_phi,"f_lept4_phi/F");
    newtree->Branch("f_lept4_charge", &f_lept4_charge,"f_lept4_charge/F");
    newtree->Branch("f_lept4_pfx", &f_lept4_pfx,"f_lept4_pfx/F");
    newtree->Branch("f_lept4_sip", &f_lept4_sip,"f_lept4_sip/F");
    newtree->Branch("f_lept4_pdgid", &f_lept4_pdgid,"f_lept4_pdgid/I");
    newtree->Branch("f_iso_max", &f_iso_max,"f_iso_max/F");
    newtree->Branch("f_sip_max", &f_sip_max,"f_sip_max/F");
    newtree->Branch("f_Z1mass", &f_Z1mass,"f_Z1mass/F");
    newtree->Branch("f_Z2mass", &f_Z2mass,"f_Z2mass/F");
    newtree->Branch("f_angle_costhetastar", &f_angle_costhetastar,"f_angle_costhetastar/F");
    newtree->Branch("f_angle_costheta1", &f_angle_costheta1,"f_angle_costheta1/F");
    newtree->Branch("f_angle_costheta2", &f_angle_costheta2,"f_angle_costheta2/F");
    newtree->Branch("f_angle_phi", &f_angle_phi,"f_angle_phi/F");
    newtree->Branch("f_angle_phistar1", &f_angle_phistar1,"f_angle_phistar1/F");
    newtree->Branch("f_pt4l", &f_pt4l,"f_pt4l/F");
    newtree->Branch("f_eta4l", &f_eta4l,"f_eta4l/F");
    newtree->Branch("f_mass4l", &f_mass4l,"f_mass4l/F");
    newtree->Branch("f_mass4lErr", &f_mass4lErr,"f_mass4lErr/F");
    newtree->Branch("f_njets_pass", &f_njets_pass,"f_njets_pass/F");
    newtree->Branch("f_deltajj", &f_deltajj,"f_deltajj/F");
    newtree->Branch("f_massjj", &f_massjj,"f_massjj/F");
    newtree->Branch("f_D_jet", &f_D_jet,"f_D_jet/F");
    newtree->Branch("f_jet1_pt", &f_jet1_pt,"f_jet1_pt/F");
    newtree->Branch("f_jet1_eta", &f_jet1_eta,"f_jet1_eta/F");
    newtree->Branch("f_jet1_phi", &f_jet1_phi,"f_jet1_phi/F");
    newtree->Branch("f_jet1_e", &f_jet1_e,"f_jet1_e/F");
    newtree->Branch("f_jet2_pt", &f_jet2_pt,"f_jet2_pt/F");
    newtree->Branch("f_jet2_eta", &f_jet2_eta,"f_jet2_eta/F");
    newtree->Branch("f_jet2_phi", &f_jet2_phi,"f_jet2_phi/F");
    newtree->Branch("f_jet2_e", &f_jet2_e,"f_jet2_e/F");
    newtree->Branch("f_D_bkg_kin", &f_D_bkg_kin,"f_D_bkg_kin/F");
    newtree->Branch("f_D_bkg", &f_D_bkg,"f_D_bkg/F");
    newtree->Branch("f_D_gg", &f_D_gg,"f_D_gg/F");
    newtree->Branch("f_D_g4", &f_D_g4,"f_D_g4/F");
    newtree->Branch("f_Djet_VAJHU", &f_Djet_VAJHU,"f_Djet_VAJHU/F");
    newtree->Branch("f_pfmet", &f_pfmet,"f_pfmet/F");
    newtree->Branch("f_genmet", &f_genmet,"f_genmet/F");
    newtree->Branch("f_mT", &f_mT,"f_mT/F");
    newtree->Branch("f_dphi", &f_dphi,"f_dphi/F");
    newtree->Branch("f_category", &f_category, "f_category/I");
    newtree->Branch("f_Ngood", &f_Ngood, "f_Ngood/I");
    newtree->Branch("f_Nbjets", &f_Nbjets, "f_Nbjets/I");
    newtree->Branch("f_Njets", &f_Njets, "f_Njets/I");
    newtree->Branch("f_NVBFjets", &f_NVBFjets, "f_NVBFjets/I");
    newtree->Branch("f_NMatchbjets", &f_NMatchbjets, "f_NMatchbjets/I");
    newtree->Branch("f_dphi_jet_met", &f_dphi_jet_met,"f_dphi_jet_met/F");
    newtree->Branch("f_min_dphi_jet_met", &f_min_dphi_jet_met,"f_min_dphi_jet_met/F");
    newtree->Branch("f_max_dphi_jet_met", &f_max_dphi_jet_met,"f_max_dphi_jet_met/F");

    mettree->Branch("f_u1",&f_u1,"f_u1/F");
    mettree->Branch("f_u2",&f_u2,"f_u2/F");
    mettree->Branch("f_z1_pt",&f_z1_pt,"f_z1_pt/F");
    mettree->Branch("f_Njets",&f_Njets,"f_Njets/I");
    mettree->Branch("f_weight", &ff_weight,"f_weight/F");
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        f_weight=1., f_int_weight=1., f_pu_weight=1., f_eff_weight=1., f_lept1_pt=-999., f_lept1_eta=-999., f_lept1_phi=-999., f_lept1_charge=-999., f_lept1_pfx=-999., f_lept1_sip=-999., f_lept2_pt=-999., f_lept2_eta=-999., f_lept2_phi=-999., f_lept2_charge=-999., f_lept2_pfx=-999., f_lept2_sip=-999., f_lept3_pt=-999., f_lept3_eta=-999., f_lept3_phi=-999., f_lept3_charge=-999., f_lept3_pfx=-999., f_lept3_sip=-999., f_lept4_pt=-999., f_lept4_eta=-999., f_lept4_phi=-999., f_lept4_charge=-999., f_lept4_pfx=-999., f_lept4_sip=-999., f_iso_max=-999., f_sip_max=-999., f_Z1mass=-999., f_Z2mass=-999., f_angle_costhetastar=-999., f_angle_costheta1=-999., f_angle_costheta2=-999., f_angle_phi=-999., f_angle_phistar1=-999., f_eta4l=-999., f_pt4l=-999., f_mass4l=-999., f_mass4lErr=-999., f_njets_pass=-999., f_deltajj=-999., f_massjj=-999., f_D_jet=-999., f_jet1_pt=-999., f_jet1_eta=-999., f_jet1_phi=-999., f_jet1_e=-999., f_jet2_pt=-999., f_jet2_eta=-999., f_jet2_phi=-999., f_jet2_e=-999.,f_D_bkg_kin=-999.,f_D_bkg=-999.,f_D_gg=-999.,f_D_g4=-999.,f_Djet_VAJHU=-999.,f_genmet=-999.,f_pfmet=-999.,f_mT=-999.,f_dphi=-999.,f_lept1_pdgid=-999,f_lept2_pdgid=-999,f_lept3_pdgid=-999,f_lept4_pdgid=-999,f_run=-999, f_lumi=-999, f_event=-999, f_category=-999, f_Ngood=-999, f_Nbjets=-999, f_NVBFjets=-999,f_NMatchbjets=-999,f_dphi_jet_met=-999., f_min_dphi_jet_met=-999., f_max_dphi_jet_met=-999.; 
        f_Njets=-999; 
        f_u1=-999, f_u2=-999;
...
*/
     ...
     //           double massZ_noFSR;
        ...
        for (uint index=0; index<Zcandvector.size();index++){
        ...
        for (uint l=0;l<Zcandisolmassvector.size();l++){
...
//        double sum_ptZ1;
        ...
        for (uint i=0;i<pTcleanedgoodZ.size();++i){
...
*/
    ...
    for(uint i= 0; i<counter_cut_PFMET.size(); i++){
        nEvent_CUT->SetBinContent(i+1,counter_cut_PFMET.at(i));
    }


    for(uint i= 0; i<counter_cut_PFMET_w.size(); i++){
